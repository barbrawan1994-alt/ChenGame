// 捕获球商店价：精灵球200 · 超级球600 · 高级球1200 · 先机球1500 · 治愈球500
export const BALLS = {
  ...
  // 适合捕捉后直接用
  heal:   { id: 'heal',   name: '治愈球', rate: 1.0, price: 500,  icon: '💖', desc: '捕获率×1.0，捕获后恢复满体力' }
};
...
export const GROWTH_ITEMS = [
  ...
  { id: 'max_candy', name: '神奇糖果', emoji: '🌟', price: 500000, desc: '等级最多提升20级（不超过Lv.100，仅限非满级精灵，需8徽章）', stat: 'level_max', val: 100 },
];
