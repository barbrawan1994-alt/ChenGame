...
export const FACTIONS = {
  wei: {
    ...
    bonus: { atk: 5, def: 5, s_atk: 0, s_def: 0, hp: 0, spd: 0, gold: 0, exp: 0, catchRate: 0 },
    bonusDesc: 'ATK/DEF +5%',
  },
  shu: {
    ...
    bonus: { atk: 0, def: 0, s_atk: 0, s_def: 0, hp: 5, spd: 0, gold: 0, exp: 10, catchRate: 0 },
    bonusDesc: 'EXP +10%, HP +5%',
  },
  wu: {
    ...
    bonus: { atk: 0, def: 0, s_atk: 0, s_def: 0, hp: 0, spd: 0, gold: 10, exp: 0, catchRate: 3 },
    bonusDesc: 'Gold +10%, 捕获率 +3%',
  },
};
