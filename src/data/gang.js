...
export const GANG_PRESETS = [
  {
    ...
    skills: { gs_atk: 2, gs_def: 1, gs_satk: 0, gs_sdef: 0, gs_hp: 1, gs_spd: 0, gs_gold: 1, gs_exp: 1 },
    wins: 24,
  ...
  },
  {
    ...
    skills: { gs_atk: 0, gs_def: 0, gs_satk: 2, gs_sdef: 0, gs_hp: 0, gs_spd: 2, gs_gold: 1, gs_exp: 1 },
    wins: 18,
  ...
  },
  {
    ...
    skills: { gs_atk: 0, gs_def: 2, gs_satk: 0, gs_sdef: 2, gs_hp: 2, gs_spd: 0, gs_gold: 0, gs_exp: 0 },
    wins: 30,
  ...
  },
  {
    ...
    skills: { gs_atk: 1, gs_def: 0, gs_satk: 1, gs_sdef: 0, gs_hp: 0, gs_spd: 2, gs_gold: 0, gs_exp: 1 },
    wins: 12,
  ...
  },
  {
    ...
    skills: { gs_atk: 0, gs_def: 1, gs_satk: 0, gs_sdef: 2, gs_hp: 2, gs_spd: 0, gs_gold: 1, gs_exp: 0 },
    wins: 22,
  ...
  },
  {
    ...
    skills: { gs_atk: 0, gs_def: 0, gs_satk: 2, gs_sdef: 1, gs_hp: 1, gs_spd: 1, gs_gold: 0, gs_exp: 1 },
    wins: 20,
  ...
  },
  {
    ...
    skills: { gs_atk: 1, gs_def: 0, gs_satk: 0, gs_sdef: 0, gs_hp: 1, gs_spd: 1, gs_gold: 0, gs_exp: 2 },
    wins: 6,
  ...
  },
  {
    ...
    skills: { gs_atk: 0, gs_def: 1, gs_satk: 0, gs_sdef: 1, gs_hp: 1, gs_spd: 0, gs_gold: 2, gs_exp: 1 },
    wins: 35,
...
export const GANG_SKILLS = [
  ...
  { id: 'gs_satk', name: '智慧结晶', desc: '全队特攻+{val}%',  maxLv: 5, costPerLv: 5000, valPerLv: 2,  icon: '🔮' },
  { id: 'gs_sdef', name: '心灵壁障', desc: '全队特防+{val}%',  maxLv: 5, costPerLv: 5000, valPerLv: 2,  icon: '🧿' },
...
export const getGangSkillBonus = (skills) => {
  if (!skills) return { atk: 0, def: 0, s_atk: 0, s_def: 0, hp: 0, spd: 0, gold: 0, exp: 0 };
  return {
    atk:   (skills.gs_atk  || 0) * 2,
    def:   (skills.gs_def  || 0) * 2,
    s_atk: (skills.gs_satk || 0) * 2,
    s_def: (skills.gs_sdef || 0) * 2,
    hp:    (skills.gs_hp   || 0) * 2,
