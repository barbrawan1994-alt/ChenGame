...
const SKILL_DB = {
  NORMAL: [
    ...
    { name: '电光一闪', p: 40, pp: 30, desc: '以极快速度冲击，必定先制' },
  ...
  FIGHT: [
    ...
    { name: '波导弹', p: 80, pp: 20, desc: '发射波导力量追踪对手，必中' },
  ...
  FLYING: [
    ...
    { name: '燕返', p: 60, pp: 20, desc: '以迅捷身法斩击，必定命中' },
  ...
  GHOST: [
    ...
    { name: '影子偷袭', p: 40, pp: 30, desc: '从影子中突然袭击，必定先制' },
    { name: '暗影拳', p: 60, pp: 20, desc: '用幽灵之拳必定命中' },
  ...
  STEEL: [
    { name: '子弹拳', p: 40, pp: 30, desc: '如子弹般的拳击，必定先制' },
  ...
  GOD: [
    { name: '神之裁决', p: 100, pp: 10, acc: 100, desc: '以神明之力裁决对手' },
    { name: '虚空破碎', p: 120, pp: 5, acc: 95, desc: '粉碎虚空的神圣一击' },
    { name: '创世之光', p: 150, pp: 5, acc: 90, desc: '释放创世时的原初光芒' },
    { name: '维度打击', p: 180, pp: 5, acc: 85, desc: '跨越维度的致命打击' },
    { name: '因果律', p: 200, pp: 1, acc: 75, desc: '改写因果律的神级攻击' },
    { name: '万物归零', p: 220, pp: 1, acc: 70, desc: '将一切归于虚无的毁灭之力' },
    { name: '宇宙大爆炸', p: 250, pp: 1, acc: 60, desc: '引发宇宙级大爆炸的究极招式' },
    { name: '终焉之刻', p: 280, pp: 1, acc: 50, desc: '终结一切的禁忌之力，命中极低' }
  ],
  COSMIC: [
    ...
    { name: '虚空坍缩', p: 140, pp: 3, desc: '令空间坍缩碾压一切' },
    { name: '创世大爆炸', p: 170, pp: 3, desc: '模拟宇宙起源的终极爆炸' },
    { name: '维度崩塌', p: 200, pp: 1, desc: '令整个维度崩塌的禁忌之力' }
  ],
  SOUND: [
