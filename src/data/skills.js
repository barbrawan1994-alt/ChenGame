...
const SKILL_DB = {
  ...
  WIND: [
    ...
    { name: '真空波', p: 50, pp: 20, priority: 1, desc: '制造真空冲击波，必定先手' },
...
const STATUS_SKILLS_DB = [
  ...
  { name: '蘑菇孢子', t: 'GRASS', p: 0, pp: 15, effect: { type: 'STATUS', status: 'SLP', chance: 0.75 }, desc: '75%使对手睡眠(2-4回合无法行动)' },
  { name: '奇异光线', t: 'GHOST', p: 0, pp: 10, effect: { type: 'STATUS', status: 'CON', chance: 0.80 }, desc: '80%使对手混乱(33%概率攻击自己)' },
  ...
  { name: '大蛇瞪眼', t: 'NORMAL', p: 0, pp: 30, effect: { type: 'STATUS', status: 'PAR', chance: 0.85 }, desc: '85%使对手麻痹' },
...
const SIDE_EFFECT_SKILLS = [
  ...
  { name: '蹭蹭脸颊', t: 'ELECTRIC', p: 40, pp: 20, effect: { type: 'STATUS', status: 'PAR', chance: 0.85 }, desc: '85%麻痹对手' },
