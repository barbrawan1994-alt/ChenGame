...
export const MAPS = [
  { 
    ...
    pool: [1, 4, 8, 10, 16, 21, 41, 44, 46, 11, 101, 104, 107, 110, 115, 118, 125, 152, 161, 164, 172, 180, 191, 216, 232, 171, 175, 177, 231, 251, 384, 396, 399, 401, 413, 417, 422, 438, 441, 444, 464, 468, 472, 474], 
    drop: 50, type: 'grass', color: '#C8E6C9', gymLeader: 117, gymLvl: 15, badge: '🍃', icon: '🌿' 
  },
  { 
    id: 2, name: '回声山谷', lvl: [10, 25], 
    // 新增: 406(青苔石), 424(铁矿石)
    pool: [6, 14, 31, 34, 38, 51, 62, 64, 66, 68, 70, 72, 111, 113, 121, 133, 135, 166, 169, 181, 198, 190, 213, 230, 245, 296, 372, 73, 205, 406, 424, 453, 458, 460, 492, 499], 
  ...
  { 
    ...
    // 新增: 408(小水滴), 420(泥浆怪)
    pool: [22, 24, 26, 28, 30, 76, 79, 82, 27, 108, 120, 123, 126, 134, 136, 158, 173, 176, 206, 211, 222, 238, 246, 351, 408, 420, 466, 491], 
    drop: 350, boss: 100, type: 'water', color: '#B3E5FC', gymLeader: 23, gymLvl: 58, badge: '💧', icon: '🌊' 
  },
  { 
    id: 5, name: '熔岩火山', lvl: [40, 65], 
    // 火山保持原样，或者可以放一些耐热的
    pool: [11, 12, 13, 14, 15, 16, 17, 20, 93, 97, 104, 105, 106, 128, 155, 193, 201, 217, 233, 386, 496], 
  ...
  { 
    ...
    // 新增: 430(流星之子) - 稀有
    pool: [3, 7, 9, 13, 15, 17, 19, 23, 33, 35, 39, 43, 49, 50, 53, 56, 59, 63, 65, 69, 71, 78, 81, 84, 94, 96, 98, 103, 106, 109, 112, 117, 122, 129, 130, 132, 137, 138, 139, 141, 144, 149, 182, 183, 196, 197, 199, 208, 229, 244, 249, 37, 215, 227, 430, 435, 447, 490, 493], 
  ...
  { 
    ...
    pool: [63, 64, 65, 81, 82, 100, 101, 132, 137, 142, 145, 150, 151, 189, 200, 221, 222, 237, 253, 447, 492, 500], 
