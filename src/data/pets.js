...
// ==========================================
const GOD_PETS = [
  { id: 254, name: '起源之光', type: 'GOD', emoji: '✨', desc: '万物的起源', hp: 150, atk: 150, def: 130, s_atk: 180, s_def: 130, spd: 120 },
  { id: 255, name: '终焉之暗', type: 'GHOST', emoji: '⚫', desc: '吞噬一切的虚无', hp: 140, atk: 170, def: 110, s_atk: 170, s_def: 110, spd: 130 },
  { id: 256, name: '日轮神', type: 'FIRE', emoji: '☀️', desc: '太阳的化身', hp: 130, atk: 160, def: 110, s_atk: 170, s_def: 120, spd: 120 },
  { id: 257, name: '月华神', type: 'FAIRY', emoji: '🌙', desc: '月亮的守护者', hp: 140, atk: 100, def: 130, s_atk: 160, s_def: 160, spd: 110 },
  { id: 258, name: '星界龙王', type: 'DRAGON', emoji: '🪐', desc: '穿梭星系的巨龙', hp: 150, atk: 170, def: 120, s_atk: 150, s_def: 120, spd: 130 },
  { id: 259, name: '大地泰坦', type: 'GROUND', emoji: '🗿', desc: '支撑大陆的巨人', hp: 180, atk: 150, def: 170, s_atk: 80, s_def: 140, spd: 60 },
  { id: 260, name: '深海利维坦', type: 'WATER', emoji: '🐋', desc: '引发海啸的巨兽', hp: 170, atk: 140, def: 130, s_atk: 150, s_def: 130, spd: 90 },
  { id: 261, name: '天空主宰', type: 'FLYING', emoji: '🦅', desc: '统治苍穹的霸主', hp: 120, atk: 160, def: 100, s_atk: 140, s_def: 100, spd: 170 },
  { id: 262, name: '雷霆宙斯', type: 'ELECTRIC', emoji: '⚡', desc: '掌控雷罚的神明', hp: 130, atk: 140, def: 100, s_atk: 175, s_def: 110, spd: 150 },
  { id: 263, name: '极寒冰帝', type: 'ICE', emoji: '❄️', desc: '冻结时间的帝王', hp: 140, atk: 130, def: 120, s_atk: 170, s_def: 130, spd: 110 },
  { id: 264, name: '生命之树', type: 'GRASS', emoji: '🌳', desc: '赋予万物生机', hp: 190, atk: 90, def: 140, s_atk: 130, s_def: 160, spd: 70 },
  { id: 265, name: '死亡之翼', type: 'GHOST', emoji: '💀', desc: '带来凋零的使者', hp: 120, atk: 175, def: 100, s_atk: 160, s_def: 100, spd: 140 },
  { id: 266, name: '时光守护者', type: 'PSYCHIC', emoji: '⏳', desc: '穿梭过去未来', hp: 140, atk: 100, def: 140, s_atk: 160, s_def: 140, spd: 130 },
  { id: 267, name: '空间撕裂者', type: 'PSYCHIC', emoji: '🌌', desc: '斩断维度的利刃', hp: 130, atk: 170, def: 110, s_atk: 170, s_def: 110, spd: 120 },
  { id: 268, name: '混沌魔君', type: 'POISON', emoji: '👿', desc: '混乱与无序的源头', hp: 140, atk: 160, def: 110, s_atk: 160, s_def: 110, spd: 120 },
  { id: 269, name: '秩序圣骑', type: 'STEEL', emoji: '🛡️', desc: '绝对的正义与法则', hp: 140, atk: 130, def: 180, s_atk: 100, s_def: 170, spd: 80 },
  { id: 270, name: '武斗神', type: 'FIGHT', emoji: '👊', desc: '武道的极致', hp: 130, atk: 185, def: 110, s_atk: 90, s_def: 100, spd: 150 },
  { id: 271, name: '元素领主', type: 'NORMAL', emoji: '🎨', desc: '融合所有元素之力', hp: 150, atk: 140, def: 130, s_atk: 140, s_def: 130, spd: 120 },
  { id: 272, name: '机械降神', type: 'STEEL', emoji: '🤖', desc: '超越生物的科技顶点', hp: 150, atk: 160, def: 150, s_atk: 140, s_def: 120, spd: 100 },
  { id: 273, name: '梦境编织者', type: 'FAIRY', emoji: '🦄', desc: '编织现实与梦境', hp: 140, atk: 90, def: 120, s_atk: 170, s_def: 150, spd: 130 },
  { id: 274, name: '深渊凝视者', type: 'GHOST', emoji: '👁️', desc: '来自深渊的恐怖', hp: 130, atk: 140, def: 100, s_atk: 175, s_def: 110, spd: 140 },
  { id: 275, name: '熔岩魔神', type: 'FIRE', emoji: '🌋', desc: '沐浴岩浆的魔神', hp: 150, atk: 170, def: 130, s_atk: 150, s_def: 110, spd: 90 },
  { id: 276, name: '风暴之怒', type: 'FLYING', emoji: '🌪️', desc: '永不停息的飓风', hp: 120, atk: 150, def: 90, s_atk: 160, s_def: 100, spd: 175 },
  { id: 277, name: '剧毒母皇', type: 'POISON', emoji: '🕷️', desc: '万毒之祖', hp: 140, atk: 130, def: 120, s_atk: 160, s_def: 130, spd: 110 },
  { id: 278, name: '金刚不坏', type: 'ROCK', emoji: '💎', desc: '永恒不灭的躯体', hp: 160, atk: 150, def: 190, s_atk: 60, s_def: 150, spd: 50 },
  { id: 279, name: '幻影之王', type: 'PSYCHIC', emoji: '🎭', desc: '真假难辨的幻术', hp: 130, atk: 110, def: 110, s_atk: 170, s_def: 120, spd: 160 },
  { id: 280, name: '虫群之心', type: 'BUG', emoji: '🦗', desc: '统御亿万虫群', hp: 150, atk: 160, def: 130, s_atk: 130, s_def: 120, spd: 110 },
  { id: 281, name: '斩铁剑圣', type: 'STEEL', emoji: '⚔️', desc: '一剑开天', hp: 120, atk: 185, def: 130, s_atk: 80, s_def: 100, spd: 145 },
  { id: 282, name: '治愈女神', type: 'HEAL', emoji: '🧚‍♀️', desc: '抚平一切伤痛', hp: 180, atk: 70, def: 130, s_atk: 140, s_def: 170, spd: 100 },
  { id: 283, name: '创世元灵', type: 'GOD', emoji: '💠', desc: '一切的开始与结束', hp: 160, atk: 160, def: 140, s_atk: 160, s_def: 140, spd: 130 }
];
// ==========================================
...
const DIGIMON_PETS = [
  ...
  { id: 613, name: '铁甲炎龙', type: 'FIRE',   emoji: '🤖', hp: 85, atk: 105, def: 75, spd: 62, evo: 614, evoLvl: 55, desc: '身披机械铠甲的炎龙，左臂装载强力导弹。' },
  { id: 614, name: '龙战天尊', type: 'FIRE',   emoji: '🐉', hp: 100, atk: 135, def: 100, spd: 110, desc: '究极龙战士，勇气之力的化身，背负龙杀者之盾。' },
  // === 进化链2: 霜狼系 (ICE) ===
  ...
  { id: 617, name: '冰甲狼人', type: 'ICE',    emoji: '🐺', hp: 80, atk: 90, def: 70, spd: 95, evo: 618, evoLvl: 55, desc: '直立行走的狼人战士，格斗与冰系双修。' },
  { id: 618, name: '极冻钢狼', type: 'ICE',    emoji: '🐺', hp: 95, atk: 115, def: 110, spd: 125, desc: '全身机械化的究极狼王，装备寒冰导弹和激光炮。' },
  // === 进化链3: 赤焰系 (DRAGON) ===
  ...
  { id: 621, name: '狱炎龙将', type: 'DRAGON', emoji: '🔴', hp: 90, atk: 112, def: 75, spd: 58, evo: 622, evoLvl: 55, desc: '完全体的巨龙，背上的巨翼可引发风暴。' },
  { id: 622, name: '真红圣骑', type: 'DRAGON', emoji: '⚔️', hp: 105, atk: 138, def: 105, spd: 100, desc: '身穿红莲铠甲的圣骑士，传说中的龙族守护者。' },
  // === 进化链4: 灵狐系 (PSYCHIC) ===
  ...
  { id: 625, name: '玄阴道师', type: 'PSYCHIC', emoji: '🦊', hp: 80, atk: 85, def: 70, spd: 98, evo: 626, evoLvl: 55, desc: '精通东方法术的灵师，操控阴阳之力。' },
  { id: 626, name: '樱华巫女', type: 'PSYCHIC', emoji: '🌸', hp: 95, atk: 112, def: 90, spd: 120, desc: '究极进化的巫女战士，拥有净化万物之力。' },
  // === 进化链5: 疾风系 (WIND) ===
  ...
  { id: 629, name: '金甲快兔', type: 'WIND',   emoji: '🐰', hp: 82, atk: 88, def: 70, spd: 110, evo: 630, evoLvl: 55, desc: '全身金色铠甲的高速战士，速度惊人。' },
  { id: 630, name: '圣盾守卫', type: 'WIND',   emoji: '🐰', hp: 100, atk: 108, def: 95, spd: 130, desc: '究极巨型兽人，双臂装载终极火力。' },
  // === 进化链6: 蓝角系 (FIGHT) ===
  ...
  { id: 633, name: '帝铠龙将', type: 'FIGHT',  emoji: '💙', hp: 85, atk: 105, def: 75, spd: 75, evo: 634, evoLvl: 55, desc: '披挂帝皇铠甲的强力龙将。' },
  { id: 634, name: '皇龙霸主', type: 'DRAGON', emoji: '💙', hp: 105, atk: 135, def: 100, spd: 108, desc: '传说中的究极龙战士，拥有毁天灭地之力。' },
  // === 进化链7: 翡甲系 (BUG) ===
  ...
  { id: 638, name: '甲虫天王', type: 'BUG',    emoji: '🪲', hp: 95, atk: 118, def: 115, spd: 85, desc: '最强的昆虫精灵，甲壳硬度堪比金刚石。' },
  // === 进化链8: 花灵系 (GRASS) ===
  ...
  { id: 642, name: '荆棘女皇', type: 'GRASS',  emoji: '🌹', hp: 95, atk: 110, def: 90, spd: 105, desc: '优雅绝美的究极花之女王，荆棘是她的武器。' },
  // === 进化链9: 波涛系 (WATER) ===
  ...
  { id: 646, name: '冰海战神', type: 'WATER',  emoji: '🦭', hp: 108, atk: 110, def: 120, spd: 60, desc: '海洋的霸主，拥有操控极地冰洋的力量。' },
  // === 进化链10: 圣翼系 (LIGHT) ===
  ...
  { id: 649, name: '神圣光使', type: 'LIGHT',  emoji: '👼', hp: 85, atk: 100, def: 80, spd: 85, evo: 650, evoLvl: 55, desc: '八翼大天使，手持净化之剑。' },
  { id: 650, name: '炽天圣翼', type: 'LIGHT',  emoji: '👼', hp: 105, atk: 130, def: 105, spd: 105, desc: '十翼炽天使，天堂三大天使之一。' },
  // === 进化链11: 圣猫系 (FAIRY) ===
  ...
  { id: 653, name: '圣辉神龙', type: 'FAIRY',  emoji: '🐉', hp: 90, atk: 105, def: 88, spd: 92, evo: 654, evoLvl: 55, desc: '闪耀着圣光的神龙，守护世界的秩序。' },
  { id: 654, name: '天轮圣女', type: 'FAIRY',  emoji: '👸', hp: 105, atk: 125, def: 110, spd: 108, desc: '天堂三大天使之一，以慈悲之心庇护万物。' },
  // === 进化链12: 毒蛛系 (POISON) ===
  ...
  { id: 657, name: '噬魂螳魔', type: 'POISON', emoji: '🪲', hp: 82, atk: 95, def: 70, spd: 80, evo: 658, evoLvl: 55, desc: '恐怖的巨型螳螂，剪刀般的大颚威力惊人。' },
  { id: 658, name: '天蝎帝王', type: 'POISON', emoji: '🪲', hp: 95, atk: 125, def: 85, spd: 95, desc: '毒虫精灵的最终进化，甲壳反射一切攻击。' },
  // === 进化链13: 猎鹰系 (FLYING) ===
  ...
  { id: 661, name: '天翼骑兵', type: 'FLYING', emoji: '🦅', hp: 84, atk: 92, def: 70, spd: 90, evo: 662, evoLvl: 55, desc: '人鹰合体的神秘空中战士。' },
  { id: 662, name: '凰翼战姬', type: 'FLYING', emoji: '🦅', hp: 100, atk: 118, def: 92, spd: 115, desc: '掌管天空战场的究极战女神。' },
  // === 进化链14: 铁壁系 (STEEL) ===
  ...
  { id: 665, name: '圣铁合体', type: 'STEEL',  emoji: '🛡️', hp: 90, atk: 75, def: 112, spd: 48, evo: 666, evoLvl: 55, desc: '天使与龙合体的神秘铁壁战士。' },
...
// === 精灵 701-800（pokeapi 图鉴序号对应立绘；原创中文名） ===
const SANGUO_PETS = [
  { id: 701, name: '飞将战禽', type: 'FIGHT', type2: 'FLYING', emoji: '🤸', hp: 72, atk: 92, def: 68 },
  { id: 702, name: '锦囊鼠师', type: 'ELECTRIC', type2: 'FAIRY', emoji: '🐭', hp: 52, atk: 58, def: 48 },
  { id: 703, name: '玉碑石将', type: 'ROCK', type2: 'FAIRY', emoji: '💎', hp: 62, atk: 52, def: 78 },
  { id: 704, name: '涎甲蛹卒', type: 'DRAGON', type2: 'POISON', emoji: '🐛', hp: 45, atk: 50, def: 40, evo: 705, evoLvl: 40 },
  { id: 705, name: '涎甲龙童', type: 'DRAGON', type2: 'POISON', emoji: '🐌', hp: 62, atk: 72, def: 55, evo: 706, evoLvl: 50 },
  { id: 706, name: '仁涎龙将', type: 'DRAGON', type2: 'WATER', emoji: '🫧', hp: 88, atk: 105, def: 85 },
  { id: 707, name: '锁钥灵妖', type: 'STEEL', type2: 'FAIRY', emoji: '🗝️', hp: 52, atk: 62, def: 58 },
  { id: 708, name: '枯木幽卒', type: 'GHOST', type2: 'GRASS', emoji: '🪵', hp: 42, atk: 48, def: 42, evo: 709, evoLvl: 25 },
  { id: 709, name: '古碑鬼将', type: 'GHOST', type2: 'GRASS', emoji: '🪬', hp: 72, atk: 90, def: 78 },
  { id: 710, name: '灯笼幽兵', type: 'GHOST', type2: 'GRASS', emoji: '🎃', hp: 44, atk: 50, def: 52, evo: 711, evoLvl: 30 },
  { id: 711, name: '焰首鬼将', type: 'GHOST', type2: 'GRASS', emoji: '🕯️', hp: 78, atk: 88, def: 85 },
  { id: 712, name: '霜翅冰蛾', type: 'ICE', type2: 'ROCK', emoji: '🧊', hp: 52, atk: 48, def: 58 },
  { id: 713, name: '铜甲战象', type: 'ICE', type2: 'ROCK', emoji: '🏔️', hp: 82, atk: 92, def: 100 },
  { id: 714, name: '暗翼蝠卒', type: 'FLYING', type2: 'SOUND', emoji: '🦇', hp: 48, atk: 45, def: 40, evo: 715, evoLvl: 48 },
  { id: 715, name: '啸翼飞龙', type: 'DRAGON', type2: 'SOUND', emoji: '🔊', hp: 82, atk: 95, def: 75 },
  { id: 716, name: '天狼剑神', type: 'FAIRY', type2: 'LIGHT', emoji: '🔰', hp: 120, atk: 128, def: 115 },
  { id: 717, name: '上古龙魂', type: 'DARK', type2: 'FLYING', emoji: '🌑', hp: 118, atk: 132, def: 105 },
  { id: 718, name: '秩序蟒帝', type: 'DRAGON', type2: 'GROUND', emoji: '🐍', hp: 115, atk: 120, def: 118 },
  { id: 719, name: '灵机仙姬', type: 'ROCK', type2: 'FAIRY', emoji: '💠', hp: 108, atk: 115, def: 108 },
  { id: 720, name: '暗影武魂', type: 'PSYCHIC', type2: 'DARK', emoji: '⭕', hp: 110, atk: 125, def: 100 },
  { id: 721, name: '沸泉火兽', type: 'FIRE', type2: 'WATER', emoji: '♨️', hp: 82, atk: 95, def: 85 },
  { id: 722, name: '翠羽雏将', type: 'GRASS', type2: 'FLYING', emoji: '🦉', hp: 48, atk: 52, def: 48, evo: 723, evoLvl: 17 },
  { id: 723, name: '翠羽参军', type: 'GRASS', type2: 'FLYING', emoji: '🪶', hp: 65, atk: 72, def: 62, evo: 724, evoLvl: 36 },
  { id: 724, name: '羽林神射', type: 'GRASS', type2: 'GHOST', emoji: '🏹', hp: 82, atk: 102, def: 78 },
  { id: 725, name: '炎猫幼卒', type: 'FIRE', type2: 'NORMAL', emoji: '🐱', hp: 45, atk: 58, def: 42, evo: 726, evoLvl: 17 },
  { id: 726, name: '炎猫校尉', type: 'FIRE', type2: 'DARK', emoji: '🐆', hp: 62, atk: 82, def: 58, evo: 727, evoLvl: 34 },
  { id: 727, name: '烈虎上将', type: 'FIRE', type2: 'FIGHT', emoji: '🐯', hp: 88, atk: 108, def: 82 },
  { id: 728, name: '碧波蜥卒', type: 'WATER', type2: 'NORMAL', emoji: '🦭', hp: 48, atk: 50, def: 45, evo: 729, evoLvl: 17 },
  { id: 729, name: '碧波蜥卫', type: 'WATER', type2: 'FAIRY', emoji: '🎀', hp: 65, atk: 68, def: 62, evo: 730, evoLvl: 39 },
  { id: 730, name: '碧波蜥将', type: 'WATER', type2: 'FAIRY', emoji: '🎶', hp: 82, atk: 92, def: 78 },
  { id: 731, name: '啄木哨兵', type: 'NORMAL', type2: 'FLYING', emoji: '🐦', hp: 42, atk: 48, def: 40, evo: 732, evoLvl: 14 },
  { id: 732, name: '号角鸣禽', type: 'FLYING', type2: 'SOUND', emoji: '🦜', hp: 58, atk: 72, def: 58, evo: 733, evoLvl: 28 },
  { id: 733, name: '火炮巨喙', type: 'FLYING', type2: 'SOUND', emoji: '💥', hp: 78, atk: 98, def: 78 },
  { id: 734, name: '巡獴前卒', type: 'NORMAL', type2: 'DARK', emoji: '🦦', hp: 48, atk: 55, def: 42, evo: 735, evoLvl: 20 },
  { id: 735, name: '密獴都督', type: 'NORMAL', type2: 'DARK', emoji: '🕵️', hp: 72, atk: 88, def: 68 },
  { id: 736, name: '蛹甲幼虫', type: 'BUG', type2: 'NORMAL', emoji: '🐛', hp: 44, atk: 48, def: 42, evo: 737, evoLvl: 20 },
  { id: 737, name: '蓄雷方虫', type: 'BUG', type2: 'ELECTRIC', emoji: '🔋', hp: 58, atk: 62, def: 58, evo: 738, evoLvl: 36 },
  { id: 738, name: '雷戟天牛', type: 'BUG', type2: 'ELECTRIC', emoji: '🪲', hp: 78, atk: 98, def: 82 },
  { id: 739, name: '拳蟹武卒', type: 'FIGHT', type2: 'WATER', emoji: '🥊', hp: 52, atk: 68, def: 52 },
  { id: 740, name: '霜拳蟹将', type: 'ICE', type2: 'FIGHT', emoji: '❄️', hp: 78, atk: 92, def: 82 },
  { id: 741, name: '踏焰战兔', type: 'FIRE', type2: 'FLYING', emoji: '🎭', hp: 58, atk: 72, def: 55 },
  { id: 742, name: '花蜂斥候', type: 'BUG', type2: 'FAIRY', emoji: '🐝', hp: 42, atk: 42, def: 40, evo: 743, evoLvl: 18 },
  { id: 743, name: '蜜蜂仙使', type: 'BUG', type2: 'FAIRY', emoji: '✨', hp: 68, atk: 82, def: 65 },
  { id: 744, name: '岩犬幼将', type: 'ROCK', type2: 'NORMAL', emoji: '🐕', hp: 48, atk: 58, def: 45, evo: 745, evoLvl: 25 },
  { id: 745, name: '苍岩战狼', type: 'ROCK', type2: 'DARK', emoji: '🐺', hp: 78, atk: 102, def: 72 },
  { id: 746, name: '鱼群水阵', type: 'WATER', type2: 'NORMAL', emoji: '🐟', hp: 52, atk: 42, def: 45 },
  { id: 747, name: '战鸬斥候', type: 'POISON', type2: 'WATER', emoji: '🌊', hp: 48, atk: 55, def: 52 },
  { id: 748, name: '雷棘海胆', type: 'POISON', type2: 'WATER', emoji: '🪸', hp: 72, atk: 85, def: 88 },
  { id: 749, name: '泥驹传骑', type: 'GROUND', type2: 'NORMAL', emoji: '🫏', hp: 52, atk: 58, def: 52, evo: 750, evoLvl: 30 },
  { id: 750, name: '铁蹄战驹', type: 'GROUND', type2: 'NORMAL', emoji: '🐴', hp: 88, atk: 95, def: 88 },
  { id: 751, name: '水泡蛛卒', type: 'WATER', type2: 'BUG', emoji: '🕷️', hp: 42, atk: 44, def: 42, evo: 752, evoLvl: 22 },
  ...
  { id: 765, name: '智猿军师', type: 'NORMAL', type2: 'PSYCHIC', emoji: '🦧', hp: 82, atk: 72, def: 82 },
  { id: 766, name: '拳章武卒', type: 'FIGHT', type2: 'NORMAL', emoji: '🥥', hp: 78, atk: 95, def: 72 },
  { id: 767, name: '伏虫暗卒', type: 'BUG', type2: 'WATER', emoji: '🪳', hp: 42, atk: 38, def: 45, evo: 768, evoLvl: 30 },
  { id: 768, name: '星甲虫帅', type: 'BUG', type2: 'WATER', emoji: '🪖', hp: 72, atk: 95, def: 105 },
  { id: 769, name: '沙堡幽卒', type: 'GHOST', type2: 'GROUND', emoji: '🏰', hp: 48, atk: 52, def: 55, evo: 770, evoLvl: 42 },
  { id: 770, name: '沙城鬼将', type: 'GHOST', type2: 'GROUND', emoji: '🏜️', hp: 88, atk: 92, def: 95 },
  { id: 771, name: '海参太守', type: 'WATER', type2: 'POISON', emoji: '🥒', hp: 52, atk: 48, def: 62 },
  { id: 772, name: '合璧异兽', type: 'NORMAL', type2: 'STEEL', emoji: '❓', hp: 72, atk: 82, def: 78 },
  { id: 773, name: '盾甲战兽', type: 'NORMAL', type2: 'LIGHT', emoji: '🎖️', hp: 88, atk: 95, def: 88 },
  { id: 774, name: '陨星飞卫', type: 'ROCK', type2: 'COSMIC', emoji: '☄️', hp: 68, atk: 82, def: 72 },
  { id: 775, name: '安眠仙熊', type: 'NORMAL', type2: 'GRASS', emoji: '🐨', hp: 72, atk: 78, def: 72 },
  { id: 776, name: '爆甲炮龟', type: 'FIRE', type2: 'DRAGON', emoji: '🐢', hp: 82, atk: 92, def: 95 },
  { id: 777, name: '雷棘铁丸', type: 'ELECTRIC', type2: 'STEEL', emoji: '🦔', hp: 68, atk: 88, def: 78 },
  { id: 778, name: '画皮伏灵', type: 'GHOST', type2: 'FAIRY', emoji: '👻', hp: 52, atk: 72, def: 48 },
  { id: 779, name: '幻纹妖鱼', type: 'WATER', type2: 'PSYCHIC', emoji: '🐠', hp: 72, atk: 88, def: 68 },
  { id: 780, name: '白须仁龙', type: 'DRAGON', type2: 'NORMAL', emoji: '🧓', hp: 82, atk: 72, def: 82 },
  { id: 781, name: '暗影游龙', type: 'GHOST', type2: 'GRASS', emoji: '⚓', hp: 78, atk: 95, def: 88 },
  { id: 782, name: '鳞甲幼龙', type: 'DRAGON', type2: 'FIGHT', emoji: '🦕', hp: 48, atk: 58, def: 52, evo: 783, evoLvl: 35 },
  { id: 783, name: '鳞甲龙卫', type: 'DRAGON', type2: 'FIGHT', emoji: '🐊', hp: 68, atk: 88, def: 72, evo: 784, evoLvl: 45 },
  { id: 784, name: '鳞甲龙帅', type: 'DRAGON', type2: 'FIGHT', emoji: '🦖', hp: 92, atk: 110, def: 95 },
  { id: 785, name: '雷域守神', type: 'ELECTRIC', type2: 'FAIRY', emoji: '🌩️', hp: 112, atk: 135, def: 105 },
  { id: 786, name: '灵域守神', type: 'PSYCHIC', type2: 'FAIRY', emoji: '🌸', hp: 110, atk: 128, def: 108 },
  ...
  { id: 794, name: '巨力蚊将', type: 'BUG', type2: 'FIGHT', emoji: '🦟', hp: 105, atk: 145, def: 95 },
  { id: 795, name: '纤影飞仙', type: 'BUG', type2: 'LIGHT', emoji: '🪲', hp: 92, atk: 128, def: 82 },
  { id: 796, name: '雷蔓妖树', type: 'ELECTRIC', type2: 'COSMIC', emoji: '🌐', hp: 95, atk: 135, def: 88 },
  { id: 797, name: '天铁竹灵', type: 'STEEL', type2: 'FLYING', emoji: '🚀', hp: 102, atk: 118, def: 115 },
  { id: 798, name: '纸刃剑仙', type: 'GRASS', type2: 'STEEL', emoji: '📄', hp: 88, atk: 148, def: 95 },
  { id: 799, name: '深渊噬兽', type: 'DARK', type2: 'DRAGON', emoji: '👄', hp: 125, atk: 115, def: 95 },
  { id: 800, name: '永劫魔龙', type: 'LIGHT', type2: 'COSMIC', emoji: '🔆', hp: 128, atk: 148, def: 120 },
];
