...
const SANGUO_PETS = [
  { id: 701, name: '摔角战隼', type: 'FIGHT', type2: 'FLYING', emoji: '🦅', hp: 72, atk: 92, def: 68 },
  { id: 702, name: '蓄电齿鼠', type: 'ELECTRIC', type2: 'FAIRY', emoji: '🐭', hp: 52, atk: 58, def: 48 },
  { id: 703, name: '晶簇石灵', type: 'ROCK', type2: 'FAIRY', emoji: '💎', hp: 62, atk: 52, def: 78 },
  { id: 704, name: '黏涎龙蛹', type: 'DRAGON', type2: 'POISON', emoji: '🐛', hp: 45, atk: 50, def: 40, evo: 705, evoLvl: 40 },
  { id: 705, name: '滑膜龙童', type: 'DRAGON', type2: 'POISON', emoji: '🐌', hp: 62, atk: 72, def: 55, evo: 706, evoLvl: 50 },
  { id: 706, name: '浆胶龙尊', type: 'DRAGON', type2: 'WATER', emoji: '🐉', hp: 88, atk: 105, def: 85 },
  { id: 707, name: '钥环灵妖', type: 'STEEL', type2: 'FAIRY', emoji: '🗝️', hp: 52, atk: 62, def: 58 },
  { id: 708, name: '哭木桩魂', type: 'GHOST', type2: 'GRASS', emoji: '🪵', hp: 42, atk: 48, def: 42, evo: 709, evoLvl: 25 },
  { id: 709, name: '古榕树魁', type: 'GHOST', type2: 'GRASS', emoji: '🌳', hp: 72, atk: 90, def: 78 },
  { id: 710, name: '灯笼瓜灵', type: 'GHOST', type2: 'GRASS', emoji: '🎃', hp: 44, atk: 50, def: 52, evo: 711, evoLvl: 30 },
  { id: 711, name: '刻面巨瓤', type: 'GHOST', type2: 'GRASS', emoji: '🕯️', hp: 78, atk: 88, def: 85 },
  { id: 712, name: '碎冰原核', type: 'ICE', type2: 'ROCK', emoji: '🧊', hp: 52, atk: 48, def: 58 },
  { id: 713, name: '冰峦巨龟', type: 'ICE', type2: 'ROCK', emoji: '🏔️', hp: 82, atk: 92, def: 100 },
  { id: 714, name: '颤音蝠婴', type: 'FLYING', type2: 'SOUND', emoji: '🦇', hp: 48, atk: 45, def: 40, evo: 715, evoLvl: 48 },
  { id: 715, name: '夜啸音龙', type: 'DRAGON', type2: 'SOUND', emoji: '🐲', hp: 82, atk: 95, def: 75 },
  { id: 716, name: '辉角圣鹿', type: 'FAIRY', type2: 'LIGHT', emoji: '🦌', hp: 120, atk: 128, def: 115 },
  { id: 717, name: '湮羽魔鸮', type: 'DARK', type2: 'FLYING', emoji: '🦅', hp: 118, atk: 132, def: 105 },
  { id: 718, name: '秩序盘龙', type: 'DRAGON', type2: 'GROUND', emoji: '🐍', hp: 115, atk: 120, def: 118 },
  { id: 719, name: '粉钻晶姬', type: 'ROCK', type2: 'FAIRY', emoji: '💠', hp: 108, atk: 115, def: 108 },
  { id: 720, name: '环枢魔灵', type: 'PSYCHIC', type2: 'DARK', emoji: '⭕', hp: 110, atk: 125, def: 100 },
  { id: 721, name: '沸泉汽麟', type: 'FIRE', type2: 'WATER', emoji: '♨️', hp: 82, atk: 95, def: 85 },
  { id: 722, name: '叶刃雏鸮', type: 'GRASS', type2: 'FLYING', emoji: '🦉', hp: 48, atk: 52, def: 48, evo: 723, evoLvl: 17 },
  { id: 723, name: '羽刃巡鸮', type: 'GRASS', type2: 'FLYING', emoji: '🪶', hp: 65, atk: 72, def: 62, evo: 724, evoLvl: 36 },
  { id: 724, name: '影箭冥鸮', type: 'GRASS', type2: 'GHOST', emoji: '🏹', hp: 82, atk: 102, def: 78 },
  { id: 725, name: '炽焰幼猫', type: 'FIRE', type2: 'NORMAL', emoji: '🐱', hp: 45, atk: 58, def: 42, evo: 726, evoLvl: 17 },
  { id: 726, name: '蹈焰豹猫', type: 'FIRE', type2: 'DARK', emoji: '🐆', hp: 62, atk: 82, def: 58, evo: 727, evoLvl: 34 },
  { id: 727, name: '烈焰魁虎', type: 'FIRE', type2: 'FIGHT', emoji: '🐯', hp: 88, atk: 108, def: 82 },
  { id: 728, name: '泡沫海狮', type: 'WATER', type2: 'NORMAL', emoji: '🦭', hp: 48, atk: 50, def: 45, evo: 729, evoLvl: 17 },
  { id: 729, name: '旋舞海狮', type: 'WATER', type2: 'FAIRY', emoji: '💃', hp: 65, atk: 68, def: 62, evo: 730, evoLvl: 39 },
  { id: 730, name: '珠歌海姬', type: 'WATER', type2: 'FAIRY', emoji: '🎶', hp: 82, atk: 92, def: 78 },
  { id: 731, name: '啄木雏雀', type: 'NORMAL', type2: 'FLYING', emoji: '🐦', hp: 42, atk: 48, def: 40, evo: 732, evoLvl: 14 },
  { id: 732, name: '号角巨喙', type: 'FLYING', type2: 'SOUND', emoji: '🦜', hp: 58, atk: 72, def: 58, evo: 733, evoLvl: 28 },
  { id: 733, name: '炮铳巨嘴', type: 'FLYING', type2: 'SOUND', emoji: '💥', hp: 78, atk: 98, def: 78 },
  { id: 734, name: '獴牙巡卫', type: 'NORMAL', type2: 'DARK', emoji: '🦦', hp: 48, atk: 55, def: 42, evo: 735, evoLvl: 20 },
  { id: 735, name: '探长獴帅', type: 'NORMAL', type2: 'DARK', emoji: '🕵️', hp: 72, atk: 88, def: 68 },
  { id: 736, name: '穴潜幼虫', type: 'BUG', type2: 'NORMAL', emoji: '🐛', hp: 44, atk: 48, def: 42, evo: 737, evoLvl: 20 },
  { id: 737, name: '蓄电鞘蛹', type: 'BUG', type2: 'ELECTRIC', emoji: '🔋', hp: 58, atk: 62, def: 58, evo: 738, evoLvl: 36 },
  { id: 738, name: '雷戟锹甲', type: 'BUG', type2: 'ELECTRIC', emoji: '🪲', hp: 78, atk: 98, def: 82 },
  { id: 739, name: '拳螯斗士', type: 'FIGHT', type2: 'WATER', emoji: '🦀', hp: 52, atk: 68, def: 52 },
  { id: 740, name: '雪绒拳蟹', type: 'ICE', type2: 'FIGHT', emoji: '🦀', hp: 78, atk: 92, def: 82 },
  { id: 741, name: '舞焰雀翎', type: 'FIRE', type2: 'FLYING', emoji: '🎭', hp: 58, atk: 72, def: 55 },
  { id: 742, name: '粉翅蜂灵', type: 'BUG', type2: 'FAIRY', emoji: '🐝', hp: 42, atk: 42, def: 40, evo: 743, evoLvl: 18 },
  { id: 743, name: '蜜晶蜂后', type: 'BUG', type2: 'FAIRY', emoji: '✨', hp: 68, atk: 82, def: 65 },
  { id: 744, name: '烁岩幼犬', type: 'ROCK', type2: 'NORMAL', emoji: '🐕', hp: 48, atk: 58, def: 45, evo: 745, evoLvl: 25 },
  { id: 745, name: '月嚎岩狼', type: 'ROCK', type2: 'DARK', emoji: '🐺', hp: 78, atk: 102, def: 72 },
  { id: 746, name: '弱群银鱼', type: 'WATER', type2: 'NORMAL', emoji: '🐟', hp: 52, atk: 42, def: 45 },
  { id: 747, name: '棘冠海星', type: 'POISON', type2: 'WATER', emoji: '🌊', hp: 48, atk: 55, def: 52 },
  { id: 748, name: '毒冠海棘', type: 'POISON', type2: 'WATER', emoji: '🪸', hp: 72, atk: 85, def: 88 },
  { id: 749, name: '泥蹄驴驹', type: 'GROUND', type2: 'NORMAL', emoji: '🫏', hp: 52, atk: 58, def: 52, evo: 750, evoLvl: 30 },
  { id: 750, name: '泥铠重马', type: 'GROUND', type2: 'NORMAL', emoji: '🐴', hp: 88, atk: 95, def: 88 },
  { id: 751, name: '泡膜幼蛛', type: 'WATER', type2: 'BUG', emoji: '🕷️', hp: 42, atk: 44, def: 42, evo: 752, evoLvl: 22 },
  { id: 752, name: '水幕巨蛛', type: 'WATER', type2: 'BUG', emoji: '🕸️', hp: 72, atk: 78, def: 78 },
  { id: 753, name: '镰叶草螳', type: 'GRASS', type2: 'BUG', emoji: '🌿', hp: 44, atk: 52, def: 42, evo: 754, evoLvl: 34 },
  { id: 754, name: '花刃艳螳', type: 'GRASS', type2: 'FIGHT', emoji: '🌺', hp: 72, atk: 95, def: 68 },
  { id: 755, name: '荧光菇灵', type: 'GRASS', type2: 'FAIRY', emoji: '🍄', hp: 48, atk: 42, def: 48 },
  { id: 756, name: '幽菇灯姬', type: 'GRASS', type2: 'FAIRY', emoji: '💡', hp: 78, atk: 82, def: 82 },
  { id: 757, name: '焰蜥毒童', type: 'POISON', type2: 'FIRE', emoji: '🦎', hp: 44, atk: 52, def: 40, evo: 758, evoLvl: 33 },
  { id: 758, name: '焰冠毒后', type: 'POISON', type2: 'FIRE', emoji: '👑', hp: 72, atk: 92, def: 68 },
  { id: 759, name: '毛绒熊崽', type: 'NORMAL', type2: 'FIGHT', emoji: '🧸', hp: 55, atk: 72, def: 48, evo: 760, evoLvl: 27 },
  { id: 760, name: '狂澜巨熊', type: 'NORMAL', type2: 'FIGHT', emoji: '🐻', hp: 92, atk: 110, def: 82 },
  { id: 761, name: '甜果芽精', type: 'GRASS', type2: 'FAIRY', emoji: '🍓', hp: 44, atk: 42, def: 42, evo: 762, evoLvl: 18 },
  { id: 762, name: '旋果舞者', type: 'GRASS', type2: 'FAIRY', emoji: '💃', hp: 58, atk: 62, def: 58, evo: 763, evoLvl: 39 },
  { id: 763, name: '果冠女王', type: 'GRASS', type2: 'FIGHT', emoji: '👑', hp: 78, atk: 105, def: 78 },
  { id: 764, name: '花环灵使', type: 'FAIRY', type2: 'HEAL', emoji: '💐', hp: 58, atk: 62, def: 68 },
  { id: 765, name: '智猿先知', type: 'NORMAL', type2: 'PSYCHIC', emoji: '🦧', hp: 82, atk: 72, def: 82 },
  { id: 766, name: '椰勇战猴', type: 'FIGHT', type2: 'NORMAL', emoji: '🥥', hp: 78, atk: 95, def: 72 },
  { id: 767, name: '怯行潮虫', type: 'BUG', type2: 'WATER', emoji: '🪳', hp: 42, atk: 38, def: 45, evo: 768, evoLvl: 30 },
  { id: 768, name: '重甲战蠊', type: 'BUG', type2: 'WATER', emoji: '🛡️', hp: 72, atk: 95, def: 105 },
  { id: 769, name: '沙墓童灵', type: 'GHOST', type2: 'GROUND', emoji: '🏰', hp: 48, atk: 52, def: 55, evo: 770, evoLvl: 42 },
  { id: 770, name: '沙城巨灵', type: 'GHOST', type2: 'GROUND', emoji: '🏜️', hp: 88, atk: 92, def: 95 },
  { id: 771, name: '闭目海参', type: 'WATER', type2: 'POISON', emoji: '🥒', hp: 52, atk: 48, def: 62 },
  { id: 772, name: '代号零兽', type: 'NORMAL', type2: 'STEEL', emoji: '❓', hp: 72, atk: 82, def: 78 },
  { id: 773, name: '万象灵铠', type: 'NORMAL', type2: 'LIGHT', emoji: '✨', hp: 88, atk: 95, def: 88 },
  { id: 774, name: '陨核星虫', type: 'ROCK', type2: 'COSMIC', emoji: '☄️', hp: 68, atk: 82, def: 72 },
  { id: 775, name: '抱竹睡熊', type: 'NORMAL', type2: 'GRASS', emoji: '🐨', hp: 72, atk: 78, def: 72 },
  { id: 776, name: '爆铠炮龟', type: 'FIRE', type2: 'DRAGON', emoji: '🐢', hp: 82, atk: 92, def: 95 },
  { id: 777, name: '棘雷丸兽', type: 'ELECTRIC', type2: 'STEEL', emoji: '⚡', hp: 68, atk: 88, def: 78 },
  { id: 778, name: '画皮小妖', type: 'GHOST', type2: 'FAIRY', emoji: '👻', hp: 52, atk: 72, def: 48 },
  { id: 779, name: '齿纹幻鱼', type: 'WATER', type2: 'PSYCHIC', emoji: '🐠', hp: 72, atk: 88, def: 68 },
  { id: 780, name: '云游老龙', type: 'DRAGON', type2: 'NORMAL', emoji: '🐉', hp: 82, atk: 72, def: 82 },
  { id: 781, name: '锚魂藻躯', type: 'GHOST', type2: 'GRASS', emoji: '⚓', hp: 78, atk: 95, def: 88 },
  { id: 782, name: '鳞角幼龙', type: 'DRAGON', type2: 'FIGHT', emoji: '🐲', hp: 48, atk: 58, def: 52, evo: 783, evoLvl: 35 },
  { id: 783, name: '战鳞龙卫', type: 'DRAGON', type2: 'FIGHT', emoji: '⚔️', hp: 68, atk: 88, def: 72, evo: 784, evoLvl: 45 },
  { id: 784, name: '龙鳞战尊', type: 'DRAGON', type2: 'FIGHT', emoji: '🛡️', hp: 92, atk: 110, def: 95 },
  { id: 785, name: '电域岛神', type: 'ELECTRIC', type2: 'FAIRY', emoji: '⚡', hp: 112, atk: 135, def: 105 },
  { id: 786, name: '幻梦岛神', type: 'PSYCHIC', type2: 'FAIRY', emoji: '🌸', hp: 110, atk: 128, def: 108 },
  { id: 787, name: '荒原岛神', type: 'GRASS', type2: 'FAIRY', emoji: '🌴', hp: 115, atk: 125, def: 110 },
  { id: 788, name: '雾礁岛神', type: 'WATER', type2: 'FAIRY', emoji: '🌊', hp: 108, atk: 122, def: 115 },
  { id: 789, name: '星尘云婴', type: 'COSMIC', type2: 'LIGHT', emoji: '☁️', hp: 42, atk: 35, def: 38, evo: 790, evoLvl: 43 },
  { id: 790, name: '金茧星胎', type: 'COSMIC', type2: 'LIGHT', emoji: '🥚', hp: 62, atk: 45, def: 95 },
  { id: 791, name: '日冕雄狮', type: 'STEEL', type2: 'LIGHT', emoji: '☀️', hp: 122, atk: 142, def: 108 },
  { id: 792, name: '月翼蝠灵', type: 'GHOST', type2: 'COSMIC', emoji: '🌙', hp: 118, atk: 138, def: 102 },
  { id: 793, name: '虚界水母', type: 'POISON', type2: 'COSMIC', emoji: '🪼', hp: 98, atk: 110, def: 85 },
  { id: 794, name: '巨肌蚊魔', type: 'BUG', type2: 'FIGHT', emoji: '🦟', hp: 105, atk: 145, def: 95 },
  { id: 795, name: '纤影飞螂', type: 'BUG', type2: 'LIGHT', emoji: '🪲', hp: 92, atk: 128, def: 82 },
  { id: 796, name: '电蔓树桩', type: 'ELECTRIC', type2: 'COSMIC', emoji: '⚡', hp: 95, atk: 135, def: 88 },
  { id: 797, name: '竹箭巨神', type: 'STEEL', type2: 'FLYING', emoji: '🚀', hp: 102, atk: 118, def: 115 },
  { id: 798, name: '纸刃飞镰', type: 'GRASS', type2: 'STEEL', emoji: '📄', hp: 88, atk: 148, def: 95 },
  { id: 799, name: '深渊巨口', type: 'DARK', type2: 'DRAGON', emoji: '👄', hp: 125, atk: 115, def: 95 },
  { id: 800, name: '棱镜古龙', type: 'LIGHT', type2: 'COSMIC', emoji: '💎', hp: 128, atk: 148, def: 120 },
];
