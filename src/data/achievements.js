...
const ACHIEVEMENTS = [
  ...
  { id: 'catch_500',       cat: 'COLLECTION', rarity: 'LEGENDARY', name: '图鉴完成者',   desc: '收集全部600种精灵！',          check: s => s.dexCount >= 600,      reward: { gold: 100000, title: '图鉴大师' } },
  ...
  { id: 'fruit_all',       cat: 'COLLECTION', rarity: 'LEGENDARY', name: '恶魔果实图鉴', desc: '收集全部51种恶魔果实',         check: s => s.uniqueFruits >= 51,   reward: { gold: 80000, title: '果实之王' } },
  ...
  { id: 'true_master',     cat: 'MASTERY', rarity: 'LEGENDARY', name: '真·大师',      desc: '图鉴600+全门派+联赛10+全副本+全塔', check: s => s.dexCount >= 600 && s.sectChiefsDefeated >= 12 && s.leagueWins >= 10 && s.dungeonsCleared >= 8 && s.challengesCompleted >= 12, reward: { gold: 500000, title: '真·大师' } },
