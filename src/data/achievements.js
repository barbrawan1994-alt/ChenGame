...
const ACHIEVEMENTS = [
  ...
  { id: 'dex_80',          cat: 'COLLECTION', rarity: 'UNCOMMON',  name: '精灵猎人',     desc: '图鉴中记录120种精灵',          check: s => s.dexCount >= 120,       reward: { gold: 2000 } },
  ...
  { id: 'fruit_15',        cat: 'COLLECTION', rarity: 'RARE',      name: '果实鉴赏家',   desc: '收集25种不同的恶魔果实',      check: s => s.uniqueFruits >= 25,   reward: { gold: 3000 } },
  ...
  { id: 'win_100',         cat: 'BATTLE', rarity: 'UNCOMMON',  name: '百战老兵',     desc: '累计赢得200场战斗',           check: s => s.battlesWon >= 200,    reward: { gold: 2000 } },
  ...
  { id: 'win_streak_15',   cat: 'BATTLE', rarity: 'UNCOMMON',  name: '连胜达人',   desc: '达成20场连胜',                check: s => s.maxWinStreak >= 20,   reward: { gold: 2000 } },
  ...
  { id: 'one_hit_ko',      cat: 'BATTLE', rarity: 'UNCOMMON',  name: '一击必杀',     desc: '一击秒杀100只精灵',            check: s => s.oneHitKOs >= 100,       reward: { gold: 1500 } },
  { id: 'double_effective', cat: 'BATTLE', rarity: 'UNCOMMON',  name: '双重克制',     desc: '造成双重克制伤害100次',         check: s => s.doubleEffectiveHits >= 100, reward: { gold: 1500 } },
  ...
  { id: 'infinity_15',     cat: 'EXPLORE', rarity: 'UNCOMMON',  name: '无尽攀登',     desc: '无限城堡到达第25层',          check: s => s.maxInfinityFloor >= 25, reward: { gold: 2000 } },
  ...
  { id: 'chest_hunter',    cat: 'EXPLORE', rarity: 'UNCOMMON',  name: '宝箱猎人',     desc: '开启100个地图宝箱',            check: s => s.chestsOpened >= 100,   reward: { gold: 2000 } },
  ...
  { id: 'sect_first',      cat: 'GROWTH', rarity: 'UNCOMMON',  name: '门派挑战者',     desc: '击败3位门派掌门',          check: s => s.sectChiefsDefeated >= 3, reward: { gold: 2000 } },
  ...
  { id: 'furniture_20',    cat: 'SOCIAL', rarity: 'UNCOMMON',  name: '家具大师',     desc: '摆放35件家具',                check: s => s.furnitureCount >= 35, reward: { gold: 1500 } },
  ...
  // ===== 火影忍者系列成就 (19) =====
  { id: 'ninja_chunin',     cat: 'NARUTO', rarity: 'UNCOMMON',  name: '中忍晋级',     desc: '累计通过8次忍者试炼达到中忍段位',    check: s => (s.chuninExams || 0) >= 8,   reward: { gold: 3000 } },
  ...
  { id: 'exam_perfect',     cat: 'NARUTO', rarity: 'EPIC',      name: '生存之王',     desc: '累计通过15次忍者试炼(含生存模式)', check: s => (s.chuninExams || 0) >= 15,  reward: { title: '学霸忍者', gold: 5000 } },
  ...
  // ===== 活动中心 =====
  { id: 'arena_50',         cat: 'BATTLE',   rarity: 'UNCOMMON',  name: '竞技场勇者',   desc: '竞技场累计获胜80场',          check: s => s.arenaWins >= 80,            reward: { gold: 3000 } },
  ...
  { id: 'bounty_30',        cat: 'EXPLORE',  rarity: 'UNCOMMON',  name: '赏金猎人',     desc: '累计完成50条赏金任务',        check: s => s.bountiesCompleted >= 50,    reward: { gold: 3000, title: '赏金猎人' } },
