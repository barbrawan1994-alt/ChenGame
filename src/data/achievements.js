...
const ACHIEVEMENTS = [
  ...
  { id: 'catch_650',       cat: 'COLLECTION', rarity: 'EPIC',      name: '三国收藏家',   desc: '图鉴中记录700种精灵',         check: s => s.dexCount >= 700,      reward: { gold: 80000, title: '三国收藏家' } },
  { id: 'catch_500',       cat: 'COLLECTION', rarity: 'LEGENDARY', name: '图鉴完成者',   desc: '收集全部800种精灵！',          check: s => s.dexCount >= 800,      reward: { gold: 100000, title: '图鉴大师' } },
  ...
  { id: 'underdog_win',    cat: 'BATTLE', rarity: 'RARE',      name: '后发制人',     desc: '用等级低30级以上的精灵赢得战斗', check: s => s.underdogLowLevelWins >= 1, reward: { gold: 10000 } },
  ...
  { id: 'challenge_6',     cat: 'GROWTH', rarity: 'UNCOMMON',  name: '挑战达人',     desc: '通关10座试炼塔',              check: s => s.challengesCompleted >= 10, reward: { gold: 8000 } },
  { id: 'challenge_all',   cat: 'GROWTH', rarity: 'EPIC',      name: '通关达人',     desc: '通关25座试炼塔',              check: s => s.challengesCompleted >= 25, reward: { gold: 40000, title: '全塔征服者' } },
  ...
  { id: 'gang_legend',     cat: 'SOCIAL', rarity: 'EPIC',      name: '帮派传奇',     desc: '成为帮派副帮主或更高',         check: s => s.gangRank >= 4,        reward: { gold: 30000, title: '帮派传奇' } },
  ...
  { id: 'gold_million',    cat: 'MASTERY', rarity: 'EPIC',      name: '百万富翁',     desc: '累计获得1,000,000金币',       check: s => s.totalGoldEarned >= 1000000, reward: { gold: 50000, title: '百万富翁' } },
  { id: 'completionist',   cat: 'MASTERY', rarity: 'EPIC',      name: '完美主义者',   desc: '解锁50个成就',                check: s => s.achievementCount >= 50, reward: { gold: 50000, title: '完美主义者' } },
  { id: 'all_ach_80',      cat: 'MASTERY', rarity: 'LEGENDARY', name: '成就控',       desc: '解锁80个成就',                check: s => s.achievementCount >= 80, reward: { gold: 150000, title: '成就控' } },
  { id: 'all_badges_sects', cat: 'MASTERY', rarity: 'LEGENDARY', name: '至高训练家',   desc: '全徽章+全门派+联赛冠军',      check: s => s.badgeCount >= 13 && s.sectChiefsDefeated >= 12 && s.leagueWins >= 1, reward: { gold: 100000, title: '至高训练家' } },
  ...
  { id: 'true_master',     cat: 'MASTERY', rarity: 'LEGENDARY', name: '真·大师',      desc: '图鉴700+全门派+联赛10+全副本+25座塔', check: s => s.dexCount >= 700 && s.sectChiefsDefeated >= 12 && s.leagueWins >= 10 && s.dungeonsCleared >= 8 && s.challengesCompleted >= 25, reward: { gold: 500000, title: '真·大师' } },
  ...
  { id: 'secret_marathon',    cat: 'SECRET', rarity: 'RARE',
    ...
    check: s => s.maxLongestBattle >= 50,   reward: { gold: 15000 }, hidden: true },
