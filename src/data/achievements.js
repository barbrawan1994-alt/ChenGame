...
// reward: { title, item } — 不含 gold
const ACHIEVEMENTS = [
  // ===== 收集类 — 按图鉴→捕获→闪光→神兽→果实→属性分组，组内由易到难 =====
  { id: 'catch_first',     cat: 'COLLECTION', rarity: 'COMMON',    name: '初出茅庐',     desc: '累计捕捉10只精灵',            check: s => s.totalCaught >= 10,   reward: {} },
  { id: 'catch_10',        cat: 'COLLECTION', rarity: 'COMMON',    name: '收藏爱好者',   desc: '图鉴中记录30种精灵',          check: s => s.dexCount >= 30,       reward: {} },
  { id: 'catch_50',        cat: 'COLLECTION', rarity: 'UNCOMMON',  name: '精灵猎人',     desc: '图鉴中记录80种精灵',          check: s => s.dexCount >= 80,       reward: {} },
  { id: 'catch_200',       cat: 'COLLECTION', rarity: 'RARE',      name: '精灵收割者',   desc: '累计捕捉200只精灵',           check: s => s.totalCaught >= 200,   reward: {} },
  ...
  { id: 'catch_shiny',     cat: 'COLLECTION', rarity: 'RARE',      name: '闪光猎人',     desc: '捕捉一只闪光精灵',            check: s => s.shinyCaught >= 1,     reward: {} },
  { id: 'catch_5_shiny',   cat: 'COLLECTION', rarity: 'EPIC',      name: '闪光收藏家',   desc: '捕捉5只闪光精灵',             check: s => s.shinyCaught >= 5,     reward: { title: '闪光大师' } },
  { id: 'catch_legend',    cat: 'COLLECTION', rarity: 'EPIC',      name: '神兽降临',     desc: '捕捉一只神兽',                check: s => s.legendCaught >= 1,    reward: {} },
  { id: 'catch_legend_5',  cat: 'COLLECTION', rarity: 'LEGENDARY', name: '神兽猎手',     desc: '捕捉5只不同的神兽',           check: s => s.legendCaught >= 5,    reward: { title: '神兽猎手' } },
  { id: 'catch_egg_5',     cat: 'COLLECTION', rarity: 'RARE',      name: '孵蛋达人',     desc: '成功孵化5枚精灵蛋',           check: s => s.eggsHatched >= 5,      reward: {} },
  ...
  { id: 'fruit_5',         cat: 'COLLECTION', rarity: 'UNCOMMON',  name: '果实收藏家',   desc: '收集8种不同的恶魔果实',       check: s => s.uniqueFruits >= 8,    reward: {} },
  { id: 'fruit_15',        cat: 'COLLECTION', rarity: 'RARE',      name: '果实鉴赏家',   desc: '收集20种不同的恶魔果实',      check: s => s.uniqueFruits >= 20,   reward: {} },
  { id: 'fruit_30',        cat: 'COLLECTION', rarity: 'EPIC',      name: '果实鉴定师',   desc: '收集35种不同的恶魔果实',      check: s => s.uniqueFruits >= 35,   reward: {} },
  ...
  { id: 'catch_all_type',  cat: 'COLLECTION', rarity: 'EPIC',      name: '属性大师',     desc: '捕捉所有21种属性的精灵',      check: s => s.typesCollected >= 21, reward: { title: '属性大师' } },
  { id: 'dual_collector',  cat: 'COLLECTION', rarity: 'UNCOMMON',  name: '双属性收藏家', desc: '拥有15只双属性精灵',          check: s => s.dualTypeCaught >= 15, reward: {} },
  { id: 'dual_master',     cat: 'COLLECTION', rarity: 'RARE',      name: '双属性大师',   desc: '拥有50只双属性精灵',          check: s => s.dualTypeCaught >= 50, reward: { title: '双属性大师' } },
  { id: 'cosmic_hunter',   cat: 'COLLECTION', rarity: 'UNCOMMON',  name: '宇宙猎手',     desc: '捕捉10只宇宙属性精灵',        check: s => s.cosmicCaught >= 10,   reward: {} },
  { id: 'sound_collector', cat: 'COLLECTION', rarity: 'UNCOMMON',  name: '音波收藏家',   desc: '捕捉10只音波属性精灵',        check: s => s.soundCaught >= 10,    reward: {} },

  // ===== 战斗类 — 按胜场→连胜→绝境→完美→越级→双打→技能系统分组 =====
  { id: 'win_first',       cat: 'BATTLE', rarity: 'COMMON',    name: '初次胜利',     desc: '赢得10场战斗',                check: s => s.battlesWon >= 10,     reward: {} },
  { id: 'win_50',          cat: 'BATTLE', rarity: 'UNCOMMON',  name: '百战老兵',     desc: '赢得100场战斗',               check: s => s.battlesWon >= 100,    reward: {} },
  ...
  { id: 'ko_streak_10',    cat: 'BATTLE', rarity: 'UNCOMMON',  name: '连胜达人',     desc: '达成15场连胜',                check: s => s.maxWinStreak >= 15,   reward: {} },
  ...
  { id: 'perfect_win',     cat: 'BATTLE', rarity: 'RARE',      name: '完美胜利',     desc: '在不损失HP的情况下赢得战斗',  check: s => s.perfectWins >= 1,     reward: {} },
  { id: 'perfect_10',      cat: 'BATTLE', rarity: 'EPIC',      name: '不沾一尘',     desc: '以满HP赢得战斗10次',          check: s => s.perfectWins >= 10,    reward: {} },
  { id: 'sweep_win',       cat: 'BATTLE', rarity: 'RARE',      name: '全队存活',     desc: '携带6只精灵对战训练家，全员生还',  check: s => s.sweepWins >= 1,       reward: {} },
  { id: 'underdog',        cat: 'BATTLE', rarity: 'RARE',      name: '以弱胜强',     desc: '击败等级高出20级以上的对手',   check: s => s.underdogWins >= 1,    reward: { title: '越级挑战者' } },
  { id: 'underdog_win',    cat: 'BATTLE', rarity: 'RARE',      name: '后发制人',     desc: '用等级低30级以上的精灵赢得战斗', check: s => s.underdogLowLevelWins >= 1, reward: {} },
  { id: 'crit_king',       cat: 'BATTLE', rarity: 'UNCOMMON',  name: '暴击之王',     desc: '在单场战斗中触发8次暴击',     check: s => s.maxCritsInBattle >= 8, reward: {} },
  { id: 'one_hit_ko',      cat: 'BATTLE', rarity: 'UNCOMMON',  name: '一击必杀',     desc: '一击秒杀50只精灵',            check: s => s.oneHitKOs >= 50,       reward: {} },
  { id: 'double_effective', cat: 'BATTLE', rarity: 'UNCOMMON',  name: '双重克制',     desc: '造成双重克制伤害50次',         check: s => s.doubleEffectiveHits >= 50, reward: {} },
  { id: 'double_first',    cat: 'BATTLE', rarity: 'UNCOMMON',  name: '双打初体验',   desc: '赢得第一场双打战斗',           check: s => s.doubleWins >= 1,       reward: {} },
  { id: 'double_no_faint', cat: 'BATTLE', rarity: 'RARE',      name: '双打完封',     desc: '双打战斗中4只精灵全部生还',    check: s => s.doublePerfectWins >= 1, reward: {} },
  ...
  { id: 'no_switch_win',   cat: 'BATTLE', rarity: 'RARE',      name: '坚守阵地',     desc: '整场战斗不换人击败训练家',     check: s => s.noSwitchTrainerWins >= 1, reward: {} },
  ...
  { id: 'vow_first',       cat: 'BATTLE', rarity: 'UNCOMMON',  name: '缚誓之力',     desc: '累计使用缚誓15次',            check: s => s.vowsUsed >= 15,       reward: {} },
  { id: 'vow_50',          cat: 'BATTLE', rarity: 'RARE',      name: '誓约之人',     desc: '累计使用缚誓50次',            check: s => s.vowsUsed >= 50,       reward: {} },
  { id: 'domain_first',    cat: 'BATTLE', rarity: 'RARE',      name: '领域展开',     desc: '累计展开领域10次',            check: s => s.domainsUsed >= 10,    reward: {} },
  { id: 'domain_30',       cat: 'BATTLE', rarity: 'EPIC',      name: '领域支配者',   desc: '累计展开领域30次',            check: s => s.domainsUsed >= 30,    reward: { title: '领域支配者' } },
  { id: 'fruit_transform', cat: 'BATTLE', rarity: 'UNCOMMON',  name: '恶魔觉醒',     desc: '累计在战斗中使用果实变身15次', check: s => s.fruitTransforms >= 15, reward: {} },
  ...
  { id: 'infinity_30',     cat: 'EXPLORE', rarity: 'RARE',      name: '深渊行者',     desc: '无限城堡到达第40层',          check: s => s.maxInfinityFloor >= 40, reward: {} },
  { id: 'infinity_50',     cat: 'EXPLORE', rarity: 'LEGENDARY', name: '无限征服者',   desc: '无限城堡到达第80层',          check: s => s.maxInfinityFloor >= 80, reward: { title: '无限征服者' } },
  { id: 'infinity_100',    cat: 'EXPLORE', rarity: 'LEGENDARY', name: '无限之巅',     desc: '通关无限城堡100层',           check: s => s.maxInfinityFloor >= 100, reward: { title: '无限之王' } },
  { id: 'chest_hunter',    cat: 'EXPLORE', rarity: 'UNCOMMON',  name: '宝箱猎人',     desc: '开启50个地图宝箱',            check: s => s.chestsOpened >= 50,   reward: {} },
  { id: 'night_explorer',  cat: 'EXPLORE', rarity: 'UNCOMMON',  name: '夜行探索者',   desc: '在夜晚探索100次',             check: s => s.nightExplores >= 100, reward: {} },
  { id: 'weather_master',  cat: 'EXPLORE', rarity: 'UNCOMMON',  name: '气象行者',     desc: '在4种不同天气下战斗',         check: s => s.weatherBattleTypes >= 4, reward: {} },
  ...
  { id: 'lv50_team',       cat: 'GROWTH', rarity: 'UNCOMMON',  name: '中流砥柱',     desc: '拥有3只50级以上精灵',         check: s => s.lv50PetCount >= 3,    reward: {} },
  { id: 'lv80_pet',        cat: 'GROWTH', rarity: 'RARE',      name: '精英觉醒',     desc: '培养一只精灵到80级',          check: s => s.maxPetLevel >= 80,    reward: {} },
  ...
  { id: 'fusion_master',   cat: 'GROWTH', rarity: 'RARE',      name: '融合专家',     desc: '累计融合精灵15次',            check: s => s.totalFusions >= 15,   reward: {} },
  { id: 'gold_100k',       cat: 'GROWTH', rarity: 'UNCOMMON',  name: '小富即安',     desc: '累计获得200,000金币',         check: s => s.totalGoldEarned >= 200000, reward: {} },
  { id: 'billionaire',     cat: 'GROWTH', rarity: 'EPIC',      name: '财富神话',     desc: '累计获得1亿金币',             check: s => s.totalGoldEarned >= 100000000, reward: { title: '亿万富翁' } },
  { id: 'max_intimacy',    cat: 'GROWTH', rarity: 'RARE',      name: '亲密无间',     desc: '一只精灵亲密度达到255',       check: s => s.maxIntimacy >= 255,   reward: { title: '最佳拍档' } },
  { id: 'skill_master',    cat: 'GROWTH', rarity: 'UNCOMMON',  name: '技能全才',     desc: '一只精灵学会8个不同技能',     check: s => s.maxSkillCount >= 8,    reward: {} },

  // ===== 社交/生活类 — 按家园→活动赛事→PvP→帮派→婚姻分组 =====
  { id: 'house_first',     cat: 'SOCIAL', rarity: 'COMMON',    name: '安家落户',     desc: '将房子升级到2级',             check: s => s.houseLevel >= 2,      reward: {} },
  { id: 'furniture_10',    cat: 'SOCIAL', rarity: 'UNCOMMON',  name: '室内设计师',   desc: '摆放20件家具',                check: s => s.furnitureCount >= 20, reward: {} },
  { id: 'full_house',      cat: 'SOCIAL', rarity: 'UNCOMMON',  name: '温馨满屋',     desc: '房子家具数量达到30件',        check: s => s.furnitureCount >= 30, reward: {} },
  ...
  { id: 'garden_harvest_50', cat: 'SOCIAL', rarity: 'UNCOMMON', name: '田园达人',   desc: '收获50次花园作物',            check: s => s.gardenHarvests >= 50, reward: {} },
  { id: 'fishing_5',       cat: 'SOCIAL', rarity: 'UNCOMMON',  name: '钓鱼达人',     desc: '钓鱼活动获胜10次',            check: s => s.fishingWins >= 10,    reward: {} },
  { id: 'fishing_20',      cat: 'SOCIAL', rarity: 'RARE',      name: '钓鱼大师',     desc: '钓鱼活动获胜30次',            check: s => s.fishingWins >= 30,    reward: { title: '钓王' } },
  { id: 'beauty_first',    cat: 'SOCIAL', rarity: 'UNCOMMON',  name: '选美冠军',     desc: '赢得精灵选美比赛3次',         check: s => s.beautyWins >= 3,      reward: {} },
  ...
  // ===== 精通类 — 按难度递增排列 =====
  { id: 'speed_demon',     cat: 'MASTERY', rarity: 'RARE',      name: '速攻战术',     desc: '在3回合内结束战斗20次',       check: s => s.quickWins >= 20,      reward: {} },
  { id: 'type_master',     cat: 'MASTERY', rarity: 'EPIC',      name: '属性克制大师', desc: '利用属性克制造成超级有效500次', check: s => s.superEffectiveHits >= 500, reward: {} },
  ...
  { id: 'true_master',     cat: 'MASTERY', rarity: 'LEGENDARY', name: '真·大师',      desc: '图鉴700+全门派+联赛10+全副本+25座塔', check: s => s.dexCount >= 700 && s.sectChiefsDefeated >= 12 && s.leagueWins >= 10 && s.dungeonsCleared >= 8 && s.challengesCompleted >= 25, reward: { title: '真·大师' } },
  { id: 'all_achievements', cat: 'MASTERY', rarity: 'LEGENDARY', name: '终极成就',     desc: '解锁所有其他成就',            check: s => s.achievementCount >= 99, reward: { title: '传说训练家' } },
  ...
  { id: 'lycoris_bond_max',      cat: 'SOCIAL', rarity: 'RARE',    name: '心意相通',
    desc: '搭档羁绊达到Lv3', check: s => s.maxBondLevel >= 3, reward: { title: '最佳搭档' } },
  ...
  { id: 'kw_general',       cat: 'SOCIAL',   rarity: 'RARE',      name: '封将拜印',     desc: '国战军衔达到将军',                       check: s => s.kwRankIdx >= 3,          reward: { title: '沙场将军' } },
  { id: 'kw_territory_5',   cat: 'EXPLORE',  rarity: 'EPIC',      name: '版图扩张',     desc: '己方阵营同时控制5块以上领地',           check: s => s.kwFactionTerritories >= 5, reward: {} },
  { id: 'kw_king',          cat: 'SOCIAL',   rarity: 'LEGENDARY', name: '一统天下',     desc: '国战军衔达到国主',                       check: s => s.kwRankIdx >= 5,          reward: { title: '乱世霸主' } },
  ...
  { id: 'kw_gen_dex120',    cat: 'MASTERY',  rarity: 'LEGENDARY', name: '一统天下名将', desc: '收集全部120位三国名将',                  check: s => s.kwGenDexTotal >= 120,    reward: { title: '千古一帝' }, hidden: true },

  // — 历史名战 —
  { id: 'hb_first',         cat: 'BATTLE',   rarity: 'COMMON',    name: '初涉战场',     desc: '通关第一场历史名战',                     check: s => s.hbCompleted >= 1,        reward: {} },
  { id: 'hb_era1',          cat: 'BATTLE',   rarity: 'RARE',      name: '平定黄巾',     desc: '通关群雄割据时代全部5场名战',            check: s => s.hbEra1 >= 5,            reward: { title: '乱世先锋' } },
  ...
  { id: 'kw_grand_general', cat: 'SOCIAL',   rarity: 'EPIC',      name: '位极人臣',     desc: '国战军衔达到大将军',                     check: s => s.kwRankIdx >= 4,          reward: { title: '大将军' } },
  ...
  { id: 'kw_campaign_all',  cat: 'BATTLE',   rarity: 'EPIC',      name: '战役达人',     desc: '通关本阵营全部6个战役副本',              check: s => s.kwCampaignsCleared >= 6, reward: { title: '常胜将军' } },
