...
const ACHIEVEMENTS = [
  ...
  { id: 'ko_streak_10',    cat: 'BATTLE', rarity: 'UNCOMMON',  name: '15连胜达人',   desc: '达成15场连胜',                check: s => s.maxWinStreak >= 15,   reward: {} },
  ...
  { id: 'perfect_10',      cat: 'BATTLE', rarity: 'EPIC',      name: '不沾一尘',     desc: '不受敌方伤害赢得战斗10次',    check: s => s.perfectWins >= 10,    reward: {} },
  ...
  { id: 'explore_3',       cat: 'EXPLORE', rarity: 'COMMON',    name: '六区旅行者',   desc: '探索6个不同的地图',           check: s => s.mapsVisited >= 6,     reward: {} },
  ...
  { id: 'infinity_15',     cat: 'EXPLORE', rarity: 'UNCOMMON',  name: '无尽攀登',     desc: '无限城堡到达第15层',          check: s => s.maxInfinityFloor >= 15, reward: {} },
  { id: 'infinity_30',     cat: 'EXPLORE', rarity: 'RARE',      name: '深渊行者',     desc: '无限城堡到达第30层',          check: s => s.maxInfinityFloor >= 30, reward: {} },
  ...
  { id: 'gold_100k',       cat: 'GROWTH', rarity: 'UNCOMMON',  name: '小富即安',     desc: '战斗累计获得200,000金币',         check: s => s.totalGoldEarned >= 200000, reward: {} },
  ...
  { id: 'furniture_10',    cat: 'SOCIAL', rarity: 'UNCOMMON',  name: '家具大师',     desc: '摆放20件家具',                check: s => s.furnitureCount >= 20, reward: {} },
