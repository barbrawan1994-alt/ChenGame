...
const ACHIEVEMENTS = [
  ...
  { id: 'catch_450',       cat: 'COLLECTION', rarity: 'EPIC',      name: '精灵研究家',   desc: '图鉴中记录500种精灵',         check: s => s.dexCount >= 500,      reward: { title: '精灵研究家', gold: 8000 } },
  { id: 'catch_650',       cat: 'COLLECTION', rarity: 'EPIC',      name: '三国收藏家',   desc: '图鉴中记录700种精灵',         check: s => s.dexCount >= 700,      reward: { title: '三国收藏家', gold: 10000 } },
  { id: 'catch_500',       cat: 'COLLECTION', rarity: 'LEGENDARY', name: '图鉴完成者',   desc: '收集全部800种精灵！',          check: s => s.dexCount >= 800,      reward: { title: '图鉴大师', gold: 20000 } },
  ...
  { id: 'win_200',         cat: 'BATTLE', rarity: 'RARE',      name: '战神降世',     desc: '赢得300场战斗',               check: s => s.battlesWon >= 300,    reward: { title: '战神', gold: 3000 } },
  { id: 'win_500',         cat: 'BATTLE', rarity: 'EPIC',      name: '千场勇士',     desc: '赢得800场战斗',               check: s => s.battlesWon >= 800,    reward: { title: '不败战神', gold: 8000 } },
  { id: 'win_1000',        cat: 'BATTLE', rarity: 'LEGENDARY', name: '千战不灭',     desc: '赢得1500场战斗',              check: s => s.battlesWon >= 1500,   reward: { title: '千战之王', gold: 20000 } },
  ...
  { id: 'billionaire',     cat: 'GROWTH', rarity: 'EPIC',      name: '财富神话',     desc: '战斗累计获得1亿金币',             check: s => s.totalGoldEarned >= 100000000, reward: { title: '亿万富翁', gold: 10000 } },
