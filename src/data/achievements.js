...
const ACHIEVEMENTS = [
  ...
  { id: 'dex_900',         cat: 'COLLECTION', rarity: 'LEGENDARY', name: '终极图鉴大师', desc: '收集全部900种精灵！',           check: s => s.dexCount >= 900,      reward: { title: '终极图鉴大师', gold: 50000 } },
  ...
  { id: 'fusion_strategic',cat: 'GROWTH',  rarity: 'LEGENDARY',name: '战略觉醒者',   desc: '完成1次精灵战略觉醒',           check: s => (s.fusionAwakeningTiers || 0) >= 1, reward: { title: '战略觉醒者', gold: 15000 } },
