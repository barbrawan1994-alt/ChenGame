...
const ACHIEVEMENTS = [
  ...
  { id: 'steps_1k',        cat: 'EXPLORE', rarity: 'COMMON',    name: '散步者',       desc: '在地图上行走1000步',          check: s => s.totalSteps >= 1000,   reward: { gold: 500 } },
  { id: 'steps_10k',       cat: 'EXPLORE', rarity: 'UNCOMMON',  name: '马拉松选手',   desc: '在地图上行走10000步',         check: s => s.totalSteps >= 10000,  reward: { gold: 2000 } },
