...
export const ECO_CRISES = [
  ...
  },
  {
    ...
    bossModifiers: [
      { condition: 'route:purify', effect: 'bossMult:0.85, skipMechanic:mirror_clones' },
      { condition: 'route:soothe', effect: 'bossMult:0.9, extraPhase:sleep_weak' },
  ...
  },
  {
    ...
    fusionChapter: true,
    fusionSystems: ['jutsu', 'devil_fruit', 'sect', 'general_tactic', 'kingdom'],
    routeStep: 6,
    ...
    steps: [
      ...
      { type: 'battle', title: '被盗的精灵蛋', region: 'black_market', enemyName: '黑市精英', pool: [94, 132, 199], lvl: [44, 52], count: 3, objective: 'capture_alive', varDelta: { blackMarket: -25, rhinoTrust: 10 }, fusionHints: { jutsu: 'EARTH', sectEco: ['defense'], general: 'zhao_yun' } },
      ...
      { type: 'explore', title: '砂核遗迹入口', region: 'relic_core', text: '封印大厅、重力核心与砂核中枢。星机阁/封印忍术可削弱 Boss 蓄力。', varDelta: { relicAwakening: 5 }, fusionHints: { sectEco: ['puzzle'], jutsu: 'FIRE' } },
      { type: 'boss', title: '砂核巨像', region: 'relic_core', enemyName: '砂核巨像', bossKey: 'sand_core_golem', bossId: 191, lvl: 54, drop: 10000, objective: 'purify', fusionBoss: true },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'explore', title: '黄昏布防', region: 'shrine', text: '在神社布置光源与结界。玄岩宗筑阵、沧海阁供水、封印术稳定结界。', varDelta: { lightCoverage: 20, borderSecurity: 10 }, fusionHints: { jutsu: 'WATER', sectEco: ['defense', 'heal'] } },
      ...
      { type: 'puzzle', title: '光源大阵', region: 'shrine', text: '光系精灵+封印术+水之呼吸稳定鬼血。提升 lightCoverage 可削弱 Boss。', varDelta: { lightCoverage: 15, ghostPollution: -10 }, fusionHints: { jutsu: 'FIRE', breathing: 'water' } },
  ...
  },
  {
    ...
    steps: [
      ...
      { type: 'puzzle', title: '分身大厅解谜', region: 'clone_hall', text: '古代机关需分身忍术或暗系/小型精灵同时触发多个开关。', varDelta: { relicDecode: 10, sealIntegrity: 5 }, fusionHints: { jutsu: 'WIND', reqTags: ['small'] } },
      ...
      { type: 'battle', title: '灾厄爪牙', region: 'chakra_well', enemyName: '封印暴走兽', pool: [43, 88, 117], lvl: [72, 80], count: 3, objective: 'purify', varDelta: { calamityPower: 8, chakraReserve: -5 }, fusionHints: { jutsu: 'WATER' } },
      ...
      { type: 'battle', title: '压制暴走核心', region: 'core_chamber', enemyName: '暴走核心兽', pool: [88, 117, 199], lvl: [82, 90], count: 3, objective: 'purify', varDelta: { calamityPower: -8 }, fusionHints: { jutsu: 'FIRE', general: 'hua_tuo' } },
