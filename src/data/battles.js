...
export const CHALLENGES = [
  ...
  { id: 'c2', title: '烈焰狼群', desc: '对抗火焰的精英小队',
    req: 20, boss: 13, bossLvl: 30, teamSize: 4, rewardId: 11,
...
export const ATTR_CHALLENGES = [
  ...
  { id: 'ac2', title: '深渊海王', desc: '水属性精灵的深海挑战',
    req: 30, boss: 23, bossLvl: 55, teamSize: 5, rewardId: 23, attrType: 'WATER',
    bg: 'linear-gradient(135deg, #1565C0 0%, #42A5F5 100%)', color: '#0D47A1' },
  { id: 'ac3', title: '雷霆风暴', desc: '电属性精灵的闪电战',
    req: 40, boss: 33, bossLvl: 60, teamSize: 5, rewardId: 33, attrType: 'ELECTRIC',
  ...
  { id: 'ac5', title: '暗夜侵袭', desc: '恶属性精灵的黑暗笼罩',
    req: 60, boss: 452, bossLvl: 70, teamSize: 6, rewardId: 452, attrType: 'DARK',
  ...
  { id: 'ac10', title: '格斗宗师', desc: '格斗属性的武道巅峰',
    req: 100, boss: 63, bossLvl: 80, teamSize: 6, rewardId: 63, attrType: 'FIGHT',
  ...
  { id: 'ac12', title: '念力风暴', desc: '超能属性的精神碾压',
    req: 120, boss: 354, bossLvl: 85, teamSize: 6, rewardId: 354, attrType: 'PSYCHIC',
...
export const DUNGEONS = [
  ...
  { id: 'safari_zone', name: '狩猎地带', desc: '传说/神兽高概率出没 (需10徽章)',
    type: 'catch', color: '#FF7043', icon: '🐾', recLvl: 85,
    rarity: '传说', stars: 5, tier: 4, reqBadges: 10,
    rewards: [
      { icon: '🐲', text: '随机神兽' },
      { icon: '🔴', text: '传说品质装备' }
...
export const HIGH_TIER_POOL = [3, 6, 9, 18, 33, 65, 69, 94, 130, 138, 139, 140, 143, 149, 160, 168, 182, 190, 199, 206, 241, 434, 437, 443, 446, 449, 452, 455, 459, 461, 463, 465, 467, 469, 471, 473, 475, 477, 479, 490, 491, 492, 493, 494, 495, 496, 497, 498, 499, 500, 503, 506, 518, 521, 533, 540, 544, 555, 567, 570, 592, 598, 600, 803, 805, 808, 813, 815, 817, 826, 828, 830, 832, 850, 853, 856, 859, 862, 865, 868, 872, 890]; 
