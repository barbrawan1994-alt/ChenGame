...
export const JUTSU_DB = [
  ...
  { id: 'fire_great', name: '火遁·豪火灭失', nature: 'FIRE', p: 125, pp: 5, chakraCost: 42, desc: '箭矢形爆裂火焰', cat: 'special', rank: 'A' },
  { id: 'amaterasu', name: '天照', nature: 'FIRE', p: 135, pp: 3, chakraCost: 48, desc: '无法熄灭的黑炎', cat: 'special', rank: 'A', isKekkei: true, effect: { type: 'STATUS', status: 'BRN', chance: 0.75, target: 'enemy' } },
  { id: 'fire_enton', name: '炎遁·加具土命', nature: 'FIRE', p: 158, pp: 2, chakraCost: 62, desc: '形态变化的黑炎斩击', cat: 'special', rank: 'S', isKekkei: true, recoil: 0.12 },
  ...
  { id: 'water_black', name: '水遁·黑雨', nature: 'WATER', p: 0, pp: 8, chakraCost: 24, desc: '油性黑雨削弱特防', cat: 'status', rank: 'A', effect: { type: 'DEBUFF', stat: 's_def', val: 1, target: 'enemy' } },
  { id: 'water_giant', name: '水遁·大瀑布之术', nature: 'WATER', p: 128, pp: 5, chakraCost: 44, desc: '巨量水流冲击', cat: 'special', rank: 'A' },
  { id: 'water_thousand', name: '水遁·千食鲛', nature: 'WATER', p: 118, pp: 6, chakraCost: 40, desc: '成群水鲨围攻', cat: 'special', rank: 'A' },
  { id: 'water_collab', name: '水遁·硬涡水刃', nature: 'WATER', p: 138, pp: 4, chakraCost: 50, desc: '压缩水龙卷', cat: 'special', rank: 'S', isKekkei: true, recoil: 0.10 },
  ...
  { id: 'raikiri', name: '雷切', nature: 'LIGHTNING', p: 122, pp: 5, chakraCost: 40, desc: '千鸟上位', cat: 'physical', rank: 'A', effect: { type: 'BUFF', stat: 'crit', val: 2, target: 'self', chance: 1 } },
  { id: 'lightning_clone', name: '雷遁·影分身', nature: 'LIGHTNING', p: 75, pp: 11, chakraCost: 22, desc: '雷分身炸裂', cat: 'special', rank: 'C' },
  { id: 'lightning_sword', name: '雷遁·雷传', nature: 'LIGHTNING', p: 112, pp: 6, chakraCost: 36, desc: '雷线切割', cat: 'special', rank: 'A' },
  { id: 'kirin', name: '麒麟', nature: 'LIGHTNING', p: 155, pp: 2, chakraCost: 58, desc: '引导天雷', cat: 'special', rank: 'S', isKekkei: true, recoil: 0.1 },
  ...
  { id: 'wind_repulse', name: '風遁·烈风掌', nature: 'WIND', p: 115, pp: 6, chakraCost: 37, desc: '斥力风压冲击', cat: 'special', rank: 'A' },
  { id: 'wind_vacuum_serial', name: '風遁·真空连波', nature: 'WIND', p: 108, pp: 7, chakraCost: 35, desc: '连续真空斩', cat: 'special', rank: 'A' },
  { id: 'rasenshuriken', name: '風遁·螺旋手里剑', nature: 'WIND', p: 148, pp: 3, chakraCost: 52, desc: '微观风刃风暴', cat: 'special', rank: 'S', isKekkei: true, recoil: 0.15 },
  ...
  { id: 'earth_weight', name: '土遁·加重岩之术', nature: 'EARTH', p: 0, pp: 7, chakraCost: 28, desc: '极重岩压', cat: 'status', rank: 'A', effect: { type: 'DEBUFF', stat: 'spd', val: 2, target: 'enemy' } },
  { id: 'earth_golem', name: '土遁·土石巨人', nature: 'EARTH', p: 120, pp: 6, chakraCost: 39, desc: '巨岩拳击', cat: 'physical', rank: 'A' },
  { id: 'earth_deeper', name: '土遁·地动核', nature: 'EARTH', p: 130, pp: 5, chakraCost: 43, desc: '地层隆起', cat: 'special', rank: 'A' },
  { id: 'earth_mountain', name: '土遁·山土之术', nature: 'EARTH', p: 145, pp: 3, chakraCost: 55, desc: '巨岩夹击', cat: 'physical', rank: 'S', recoil: 0.11 },
  ...
  { id: 'wood_dragon', name: '木遁·木龙之术', nature: null, p: 128, pp: 5, chakraCost: 46, desc: '木龙缠绕吸取', cat: 'special', rank: 'A', isKekkei: true, combo: 'WOOD', effect: { drain: 0.12 } },
  { id: 'lava_rubber', name: '熔遁·橡胶', nature: null, p: 118, pp: 6, chakraCost: 41, desc: '弹性熔岩弹', cat: 'special', rank: 'A', isKekkei: true, combo: 'LAVA' },
  ...
  { id: 'ice_mirror', name: '魔镜冰晶', nature: null, p: 132, pp: 4, chakraCost: 49, desc: '镜中连击', cat: 'special', rank: 'A', isKekkei: true, combo: 'ICE_RELEASE' },
  { id: 'storm_line', name: '岚遁·励挫锁苛素', nature: null, p: 124, pp: 5, chakraCost: 44, desc: '激光风暴', cat: 'special', rank: 'A', isKekkei: true, combo: 'STORM' },
  ...
  { id: 'boil_unrivaled', name: '沸遁·巧雾之术', nature: null, p: 115, pp: 6, chakraCost: 40, desc: '强酸高热雾', cat: 'special', rank: 'A', isKekkei: true, combo: 'BOIL' },
  { id: 'dust_release', name: '尘遁·原界剥离', nature: null, p: 165, pp: 2, chakraCost: 68, desc: '立方分解', cat: 'special', rank: 'S', isKekkei: true, combo: 'DUST', recoil: 0.18 },
  ...
  { id: 'sage_art_bullet', name: '仙法·五右卫门', nature: null, p: 142, pp: 4, chakraCost: 54, desc: '油风火组合', cat: 'special', rank: 'S', isSpecial: true },
  { id: 'sage_rasengan', name: '仙法·螺旋丸', nature: null, p: 125, pp: 5, chakraCost: 45, desc: '仙术强化螺旋丸', cat: 'physical', rank: 'A', isSpecial: true },
  { id: 'forbidden_heal', name: '禁术·创造再生', nature: null, p: 0, pp: 3, chakraCost: 55, desc: '透支细胞愈合', cat: 'status', rank: 'S', isSpecial: true, effect: { type: 'HEAL', val: 0.40, target: 'self' }, recoil: 0.22 },
  { id: 'edo_summon', name: '秽土转生·契', nature: null, p: 0, pp: 2, chakraCost: 60, desc: '召唤棺木束缚', cat: 'status', rank: 'S', isSpecial: true, effect: { type: 'DEBUFF', stat: 'spd', val: 2, target: 'enemy' }, recoil: 0.2 },
  { id: 'reaper_death', name: '尸鬼封尽', nature: null, p: 160, pp: 1, chakraCost: 75, desc: '死神换命封印', cat: 'special', rank: 'S', isSpecial: true, recoil: 0.32 },
  { id: 'c0_art', name: '禁术·C0', nature: null, p: 175, pp: 1, chakraCost: 72, desc: '自爆艺术', cat: 'special', rank: 'S', isSpecial: true, recoil: 0.35 },
  { id: 'eight_gates', name: '八门遁甲·朝孔雀', nature: null, p: 138, pp: 4, chakraCost: 50, desc: '极速正拳击', cat: 'physical', rank: 'A', isSpecial: true, recoil: 0.14 },
  { id: 'night_moth', name: '八门遁甲·夕象', nature: null, p: 152, pp: 3, chakraCost: 58, desc: '扭曲空间的拳击', cat: 'physical', rank: 'S', isSpecial: true, recoil: 0.2 },
  { id: 'izanagi', name: '禁术·伊邪那岐', nature: null, p: 0, pp: 2, chakraCost: 65, desc: '梦境改写现实一瞬', cat: 'status', rank: 'S', isSpecial: true, effect: { type: 'BUFF', stat: 'eva', val: 3, target: 'self' }, recoil: 0.25 },
  ...
  { id: 'tsukuyomi_glance', name: '万花筒·月读(余波)', nature: null, p: 0, pp: 6, chakraCost: 38, desc: '精神创伤', cat: 'status', rank: 'A', isSpecial: true, effect: { type: 'DEBUFF', stat: 's_atk', val: 2, target: 'enemy' } },
  { id: 'six_paths_push', name: '六道·地爆天星', nature: null, p: 148, pp: 3, chakraCost: 56, desc: '引力封印', cat: 'special', rank: 'S', isSpecial: true, recoil: 0.16 },
  { id: 'truth_orbs', name: '求道玉·湮灭', nature: null, p: 170, pp: 1, chakraCost: 78, desc: '阴阳遁抹消', cat: 'special', rank: 'S', isSpecial: true, recoil: 0.22 },
  ...
  { id: 'nj271', name: '火遁·豪焰连斩', nature: 'FIRE', p: 108, pp: 8, chakraCost: 38, desc: '豪火与斩击合一', cat: 'special', rank: 'A' },
  { id: 'nj272', name: '水遁·水铁炮(强)', nature: 'WATER', p: 114, pp: 7, chakraCost: 41, desc: '压缩水炮连射', cat: 'special', rank: 'A' },
  { id: 'nj273', name: '雷遁·神击', nature: 'LIGHTNING', p: 101, pp: 9, chakraCost: 36, desc: '雷光贯胸一击', cat: 'physical', rank: 'A', effect: { type: 'BUFF', stat: 'crit', val: 1, target: 'self', chance: 1 } },
  { id: 'nj274', name: '風遁·大镰', nature: 'WIND', p: 118, pp: 6, chakraCost: 44, desc: '巨镰风刃横斩', cat: 'special', rank: 'A' },
  { id: 'nj275', name: '土遁·山土(式)', nature: 'EARTH', p: 125, pp: 6, chakraCost: 46, desc: '夹击岩壁雏形', cat: 'physical', rank: 'A' },
  { id: 'nj276', name: '钢遁·钢化斩', nature: null, p: 112, pp: 8, chakraCost: 39, desc: '金属硬化斩击', cat: 'physical', rank: 'A', isKekkei: true, combo: 'STEEL' },
  { id: 'nj277', name: '幻术·奈落狱', nature: null, p: 0, pp: 9, chakraCost: 35, desc: '跌入深渊般恐惧', cat: 'status', rank: 'A', effect: { type: 'DEBUFF', stat: 's_atk', val: 2, target: 'enemy' } },
  { id: 'nj278', name: '仙术·油炎弹', nature: null, p: 120, pp: 7, chakraCost: 43, desc: '油与火组合轰击', cat: 'special', rank: 'A', isSpecial: true },
  { id: 'nj279', name: '血继·晶镜连', nature: null, p: 116, pp: 7, chakraCost: 40, desc: '晶遁连折射', cat: 'special', rank: 'A', isKekkei: true, combo: 'CRYSTAL' },
  { id: 'nj280', name: '火遁·炼狱幕', nature: 'FIRE', p: 96, pp: 10, chakraCost: 34, desc: '火幕封锁走位', cat: 'special', rank: 'A', effect: { type: 'DEBUFF', stat: 'eva', val: 1, target: 'enemy' } },
  { id: 'nj281', name: '水遁·海潮壁', nature: 'WATER', p: 0, pp: 8, chakraCost: 37, desc: '水壁提升特防', cat: 'status', rank: 'A', effect: { type: 'BUFF', stat: 's_def', val: 2, target: 'self' } },
  { id: 'nj282', name: '雷遁·岚蹄', nature: 'LIGHTNING', p: 110, pp: 8, chakraCost: 39, desc: '雷光蹄形踏击', cat: 'physical', rank: 'A' },
  { id: 'nj283', name: '風遁·天岚', nature: 'WIND', p: 104, pp: 9, chakraCost: 35, desc: '高空岚涡吸入', cat: 'special', rank: 'A' },
  { id: 'nj284', name: '土遁·天守', nature: 'EARTH', p: 122, pp: 6, chakraCost: 45, desc: '巨岩穹顶镇压', cat: 'special', rank: 'A' },
  { id: 'nj285', name: '体术·朝孔雀(余)', nature: null, p: 127, pp: 6, chakraCost: 42, desc: '孔雀尾焰连击余威', cat: 'physical', rank: 'A', recoil: 0.08 },
  { id: 'nj286', name: '幻术·枷楼罗', nature: null, p: 0, pp: 8, chakraCost: 32, desc: '巨鸟幻影冲心', cat: 'status', rank: 'A', effect: { type: 'DEBUFF', stat: 'spd', val: 1, target: 'enemy' } },
  { id: 'nj287', name: '磁遁·砂金缚', nature: null, p: 119, pp: 7, chakraCost: 41, desc: '砂金金属线束缚', cat: 'special', rank: 'A', isKekkei: true, combo: 'MAGNET' },
  { id: 'nj288', name: '灼遁·炎楼', nature: null, p: 113, pp: 8, chakraCost: 38, desc: '楼形热浪吞噬', cat: 'special', rank: 'A', isKekkei: true, combo: 'SCORCH' },
  { id: 'nj289', name: '岚遁·雷岚矢', nature: null, p: 106, pp: 9, chakraCost: 36, desc: '水雷共导之矢', cat: 'special', rank: 'A', isKekkei: true, combo: 'STORM' },
  { id: 'nj290', name: '水遁·激流葬', nature: 'WATER', p: 129, pp: 5, chakraCost: 48, desc: '激流漩涡葬敌', cat: 'special', rank: 'A' },

  { id: 'nj291', name: '炎遁·黑焰斩', nature: 'FIRE', p: 138, pp: 5, chakraCost: 52, desc: '黑炎与斩击相合', cat: 'special', rank: 'S', isKekkei: true, recoil: 0.11 },
  { id: 'nj292', name: '水遁·海神冲', nature: 'WATER', p: 132, pp: 6, chakraCost: 49, desc: '海量水流一冲', cat: 'special', rank: 'S' },
  { id: 'nj293', name: '雷遁·天罚雷', nature: 'LIGHTNING', p: 148, pp: 4, chakraCost: 55, desc: '垂直天雷灌顶', cat: 'special', rank: 'S', recoil: 0.09 },
  { id: 'nj294', name: '風遁·终岚', nature: 'WIND', p: 142, pp: 5, chakraCost: 51, desc: '终末暴风吞噬', cat: 'special', rank: 'S' },
  { id: 'nj295', name: '土遁·地动·极', nature: 'EARTH', p: 135, pp: 6, chakraCost: 48, desc: '地层翻覆极意', cat: 'special', rank: 'S', recoil: 0.1 },
  { id: 'nj296', name: '磁遁·砂金界法', nature: null, p: 130, pp: 7, chakraCost: 47, desc: '砂金领域封杀', cat: 'special', rank: 'S', isKekkei: true, combo: 'MAGNET' },
  { id: 'nj297', name: '灼遁·蒸灭狱', nature: null, p: 145, pp: 4, chakraCost: 58, desc: '蒸气血雾焚敌', cat: 'special', rank: 'S', isKekkei: true, combo: 'SCORCH', recoil: 0.12 },
  { id: 'nj298', name: '木遁·四柱牢', nature: null, p: 0, pp: 8, chakraCost: 46, desc: '木柱牢笼封镇', cat: 'status', rank: 'S', isKekkei: true, combo: 'WOOD', effect: { type: 'DEBUFF', stat: 'spd', val: 2, target: 'enemy' } },
  { id: 'nj299', name: '冰遁·永冻狱', nature: null, p: 152, pp: 4, chakraCost: 56, desc: '永恒寒气封冻', cat: 'special', rank: 'S', isKekkei: true, combo: 'ICE_RELEASE', effect: { type: 'STATUS', status: 'FRZ', chance: 0.28, target: 'enemy' } },
  { id: 'nj300', name: '尘遁·限界方阵', nature: null, p: 158, pp: 3, chakraCost: 64, desc: '小型立方分解', cat: 'special', rank: 'S', isKekkei: true, combo: 'DUST', recoil: 0.17 },
