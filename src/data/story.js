...
export const STORY_SCRIPT = [
  ...
  // ==========================================
  {
    ...
    tasks: [
      ...
      { step: 3, x: 22, y: 5, type: 'dialog', name: '药王谷谷主·苏夕', text: '（一个白衣女子匆匆赶来）不好了！五毒教的人在大会现场下了蛊毒——好几位门主中招了！我需要你帮我采集解毒材料...路上可能会遇到五毒教的阻拦。', emoji: '🌿' },
      { step: 4, x: 8, y: 3, type: 'battle', enemyId: 277, name: '五毒教·毒蝎使', text: '苏夕那个贱人！解毒？做梦！五毒教的蛊毒天下无解！大会上那些老东西就该死在毒中！', emoji: '☠️',
    ...
    outro: [
      ...
      { name: "药王谷谷主·苏夕", text: "解药配好了！多亏你拦住了五毒教的人。但下毒的不是五毒教教主——是有人假借五毒教之名行事。" },
      { name: "唐门少主·唐璃", text: "（面色一变）不是五毒教？那是谁...等等，我刚才收到暗报——有人盗走了唐门的'天机毒经'！" },
      { name: "系统", text: "真相逐渐浮出水面：有人在利用门派间的宿怨制造混乱。" },
      { name: "系统", text: "门派好感度系统已激活！继续调查，揭露幕后黑手。" }
    ],
  ...
  },
  {
    ...
    mapId: 9,
    title: "门派篇·贰：暗潮汹涌",
    objective: "少林与武当决裂在即，真凶利用'太虚令'制造门派大战。",
    intro: [
      { name: "仙剑大侠·李逍遥", text: "事情越来越严重了。少林方丈法海和武当祖师张三丰因为一件叫'太虚令'的远古神器反目成仇。" },
      { name: "仙剑大侠·李逍遥", text: "太虚令...传说能打开连接异界的通道。两大门派都声称是自己的祖传之物。" },
      { name: "仙剑大侠·李逍遥", text: "更糟的是——明教教主和昆仑派掌门各自收到了挑衅信，署名是对方的。这明显是有人设局！" },
      { name: "仙剑大侠·李逍遥", text: "我去调停少林和武当，你去阻止明教和昆仑的冲突。天机阁的阁主说他有线索——先去找他。" }
    ],
    tasks: [
      { step: 0, x: 8, y: 8, type: 'battle', enemyId: 292, name: '天机阁·试炼傀儡', text: '（天机阁阁主·鬼谷子设下的试炼）要见我师父？先过了我这关。阁主说：能被傀儡打败的人，不配知道真相。', emoji: '🔮',
        eliteParty: [{ id: 292, level: 78 }, { id: 140, level: 76 }, { id: 129, level: 75 }, { id: 237, level: 74 }, { id: 151, level: 73 }]
      },
      { step: 1, x: 16, y: 5, type: 'dialog', name: '天机阁阁主·鬼谷子', text: '（一个须发皆白的老者坐在棋盘前）我早就算到你会来。太虚令是假的——真正的太虚令五百年前就碎了。有人用残片伪造了一件赝品来挑拨离间。', emoji: '🔮' },
      { step: 2, x: 20, y: 12, type: 'battle', enemyId: 275, name: '明教·炎卫队长', text: '昆仑派的冰冻攻击差点杀了我们教主！今天不是你死就是我亡！（他没意识到这是陷阱）', emoji: '🔥',
        eliteParty: [{ id: 275, level: 79 }, { id: 6, level: 77 }, { id: 17, level: 76 }, { id: 157, level: 75 }, { id: 128, level: 74 }, { id: 56, level: 73 }]
      },
      { step: 3, x: 10, y: 15, type: 'battle', enemyId: 263, name: '昆仑派·寒冰长老', text: '明教那群疯子先动的手！我昆仑派岂能忍气吞声？今日便让你见识寒冰劲的威力！', emoji: '❄️',
        eliteParty: [{ id: 263, level: 80 }, { id: 234, level: 78 }, { id: 91, level: 77 }, { id: 199, level: 76 }, { id: 123, level: 75 }, { id: 131, level: 74 }]
      },
      { step: 4, x: 15, y: 3, type: 'dialog', name: '华山派掌门·令狐冲', text: '（一个潇洒的中年人倚剑而立）有意思...我也收到了昆仑派的挑战书，但笔迹不对。作为华山派掌门，我宣布——华山与你站在一起，彻查此事。', emoji: '🏔️' },
      { step: 5, x: 22, y: 8, type: 'battle', enemyId: 252, name: '黑袍人·太虚使者', text: '（一个戴着面具的黑袍人从暗处现身）可惜被你们发现了...不过没关系，门派之间的裂痕已经种下。太虚教的复兴不是你们能阻止的！', emoji: '🎭',
    ...
    outro: [
      { name: "仙剑大侠·李逍遥", text: "（御剑而来）少林和武当那边我搞定了——法海师兄和张三丰已经和解。太虚令确实是假的。" },
      { name: "天机阁阁主·鬼谷子", text: "太虚教...五百年前被十二门派联手剿灭的邪教。他们的教主'太虚真人'临死前发下誓言——五百年后卷土重来，让十二门派自相残杀。" },
      { name: "华山派掌门·令狐冲", text: "看来这个'太虚使者'只是先锋。太虚教的教主...可能已经复活了。" },
      { name: "仙剑大侠·李逍遥", text: "必须在太虚教完全复活之前将其阻止。我已经联络了各大门派——武道大会改为'讨逆联盟'。你、我、加上十二门派的力量——一起终结这一切。" },
      { name: "系统", text: "真相揭露：太虚教是幕后黑手！十二门派联盟成立，最终决战即将到来。" }
    ],
  ...
  },
  {
    chapter: 23,
    mapId: 13,
    title: "门派篇·叁：十二门派·讨逆之战",
    objective: "率领十二门派联盟，攻入太虚秘境，击败太虚教主！",
    intro: [
      ...
      { name: "唐门少主·唐璃", text: "暴雨梨花针已经淬好了最强的毒。这次——用在该用的人身上。" },
      { name: "丐帮帮主·洪七公", text: "哈哈！老叫花子许久没这么热血了！降龙十八掌，奉陪到底！" },
      { name: "仙剑大侠·李逍遥", text: "出发——目标太虚秘境！" }
    ],
    tasks: [
      { step: 0, x: 5, y: 10, type: 'battle', enemyId: 253, name: '太虚教·四大护法之风', text: '太虚教存续五百年，岂是你们这些小辈能撼动的！风之结界——起！', emoji: '🌪️',
        eliteParty: [{ id: 253, level: 86 }, { id: 249, level: 84 }, { id: 142, level: 83 }, { id: 42, level: 82 }, { id: 163, level: 81 }, { id: 15, level: 80 }]
      },
      { step: 1, x: 12, y: 5, type: 'battle', enemyId: 248, name: '太虚教·四大护法之地', text: '大地裂变！你们的联盟不过是一盘散沙——我倒要看看你们团结到什么时候！', emoji: '🌋',
        eliteParty: [{ id: 248, level: 87 }, { id: 185, level: 85 }, { id: 68, level: 84 }, { id: 184, level: 83 }, { id: 112, level: 82 }, { id: 259, level: 81 }]
      },
      { step: 2, x: 20, y: 12, type: 'dialog', name: '逍遥派掌门·无崖子', text: '（一个白发苍苍的老者闪身出现）太虚秘境的阵法我已经破解了一半。李逍遥，你带人从正门突破，我在这里维持通道。时间不多——快去！', emoji: '💨' },
      { step: 3, x: 25, y: 8, type: 'battle', enemyId: 146, name: '太虚教·四大护法之暗', text: '（一片黑暗中传来嗤笑）你们以为打败了风和地就能赢？暗之领域——在我的世界里，光明不存在。', emoji: '🌑',
        eliteParty: [{ id: 146, level: 88 }, { id: 608, level: 86 }, { id: 94, level: 85 }, { id: 59, level: 84 }, { id: 609, level: 83 }, { id: 130, level: 82 }]
      },
      { step: 4, x: 15, y: 3, type: 'battle', enemyId: 283, name: '太虚教主·太虚真人', text: '（秘境中央，一个浑身缠绕着紫黑色气流的身影睁开了眼）五百年...五百年了！十二门派的后人们，你们祖先欠我的债，今天该还了！太虚归一——万物寂灭！', emoji: '⚫',
        eliteParty: [{ id: 283, level: 92 }, { id: 254, level: 90 }, { id: 255, level: 89 }, { id: 253, level: 88 }, { id: 146, level: 87 }, { id: 248, level: 86 }]
      },
      { step: 5, x: 15, y: 8, type: 'battle', enemyId: 281, name: '仙剑大侠·李逍遥 [御剑·仙灵]', text: '（太虚真人被击败后，李逍遥将御灵剑插在地上，转身面对你）...一切都结束了。但还有一件事没完——你还记得吗？从我们第一次见面到现在，你一直在追赶我。现在...让我用蜀山最强的剑术，看看你是否已经超越了我。这一战——不是考验，是我作为剑客的最高礼遇。', emoji: '⚔️',
        eliteParty: [{ id: 281, level: 95 }, { id: 182, level: 92 }, { id: 223, level: 91 }, { id: 329, level: 90 }, { id: 249, level: 89 }, { id: 369, level: 88 }]
      }
    ],
    midEvent: { enemyId: 283, name: '太虚教主·太虚真人' },
    outro: [
      { name: "仙剑大侠·李逍遥", text: "（收剑入鞘，由衷地笑了）...你赢了。不——是你超越了我。从回声山谷的那个菜鸟，到现在站在我面前的绝世高手。这段旅途...真好。" },
      { name: "少林方丈·法海", text: "太虚教的威胁终于彻底解除了。今日之战，将载入武林史册。" },
      { name: "武当祖师·张三丰", text: "正道不孤。十二门派虽各有恩怨，但大义面前，我等不分彼此。" },
      { name: "唐门少主·唐璃", text: "（面色复杂地看向五毒教教主）...这次并肩作战，唐门欠你一个人情。旧怨...以后再说吧。" },
      { name: "五毒教教主·蓝凤凰", text: "（轻笑）人情？唐璃小子，你可别后悔。" },
      { name: "仙剑大侠·李逍遥", text: "对了...太虚真人临死前的那句话让我在意——'更大的黑暗已经苏醒'。或许...我们的战斗还没有结束。" },
      { name: "仙剑大侠·李逍遥", text: "不过那是以后的事了。今天——我们庆祝。回蜀山，我请你喝最好的灵酒！" },
      { name: "系统", text: "门派风云篇·完。十二门派联盟大胜太虚教！" },
      { name: "系统", text: "奖励：所有门派好感度+50，门派挑战难度下降，解锁隐藏称号【武林盟主】" }
    ],
    reward: { gold: 100000, balls: { master: 3 } }
  }
];
