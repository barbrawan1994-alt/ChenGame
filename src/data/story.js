// ==========================================
// 游戏剧情脚本 - 完整重制版
// 主线13章 + 咒术篇10章 + 莉可莉丝篇3章 + 门派风云篇9章 + 异界征途篇18章 + 三国篇12章
// 注意: chapter字段仅用于UI显示,不同支线可能共享chapter编号
// 实际定位使用数组索引(storyProgress)
// ==========================================
...
export const STORY_SCRIPT = [
  ...
  // ===== 第五章：熔岩火山 =====
  {
    ...
    reward: { gold: 5000, balls: { ultra: 3 }, pokemon: {id: 125, level: 30} }
  },
  ...
  // ===== 第七章：幽灵古堡 =====
  {
    ...
    tasks: [
      ...
      { step: 3, x: 20, y: 12, type: 'battle', enemyId: 609, name: '神秘训练家·厌晚', text: "（一个穿着黑色长裙的女人从阴影中走出，冰冷地注视着你）...你就是最近让日蚀队头疼的小鬼？看在你走到这里的份上，我就用三成的力量陪你玩玩。", emoji: '🌙',
        eliteParty: [
          { id: 609, level: 52 },
          { id: 94, level: 50 },
          { id: 59, level: 49 },
  ...
  // ===== 第九章：极寒冻土 =====
  {
    ...
    tasks: [
      ...
      { step: 3, x: 16, y: 8, type: 'battle', enemyId: 123, name: '日蚀队 副首领·霜', text: "冰之力量才是永恒的...在绝对零度面前，一切都将停止。包括时间本身！", emoji: '❄️',
        eliteParty: [{ id: 123, level: 76 }, { id: 199, level: 74 }, { id: 76, level: 73 }, { id: 253, level: 72 }, { id: 142, level: 71 }]
      },
    ...
    midEvent: { enemyId: 123, name: '日蚀队 副首领·霜' },
    outro: [
  ...
  // ===== 第十章：流沙荒漠 =====
  {
    ...
    tasks: [
      { step: 0, x: 5, y: 15, type: 'battle', enemyId: 68, name: '潜伏的 穿山甲', text: "（突然从沙地里钻出！沙暴让它变得异常暴躁）", emoji: '🦔',
        eliteParty: [{ id: 68, level: 82 }, { id: 185, level: 80 }, { id: 248, level: 79 }, { id: 142, level: 78 }, { id: 112, level: 79 }]
      },
  ...
  },
  {
    ...
    outro: [
      ...
      { name: "五条悟", text: "不过——那个叫羂索的家伙已经行动了。一场名为「死滅回游」的游戏...即将开始。" },
  ...
  // ===== 咒术篇·叁：死滅回游·序幕 =====
  {
    ...
    mapId: 100,
    title: "咒术篇·叁：死滅回游·序幕",
    objective: "羂索启动了「死滅回游」——一场术师间的生死游戏！在结界中生存并击败其他泳者。",
    intro: [
      { name: "伏黑惠", text: "状况很糟。羂索在全国多个地点激活了结界——「领域(コロニー)」。" },
      { name: "伏黑惠", text: "被困在结界内的人都被强制觉醒了咒力。规则只有一条：战斗，获取点数，否则死亡。" },
      { name: "五条悟", text: "死滅回游...那家伙把整个日本变成了棋盘。每个结界里都有「泳者」——术师和被觉醒的普通人。" },
      { name: "五条悟", text: "你们必须进入结界，击败危险的泳者，同时找到添加新规则的方法来拯救无辜的人。" },
      { name: "伏黑惠", text: "我会同行。津美纪...我姐姐也被卷入了。我必须救她。" }
    ],
    tasks: [
      { step: 0, x: 8, y: 12, type: 'battle', enemyId: 178, name: '觉醒泳者·暴走市民', text: "啊啊啊！？这是什么力量！？身体...不受控制...必须战斗！不战斗就会死！！", emoji: '😱',
        eliteParty: [{ id: 178, level: 74 }, { id: 92, level: 72 }, { id: 59, level: 71 }, { id: 48, level: 70 }]
      },
      { step: 1, x: 20, y: 5, type: 'dialog', name: '伏黑惠', text: "这些人只是被强制觉醒的普通市民...击倒他们不会有危险，咒力耗尽后会陷入沉睡。我们要做的是找到真正危险的泳者。", emoji: '🔷' },
      { step: 2, x: 15, y: 8, type: 'battle', enemyId: 270, name: '泳者·日車寛見', text: "（西装笔挺的男人冷冷注视）裁定。你被起诉——罪名是扰乱结界秩序。在本庭的领域中，不存在无罪的被告。", emoji: '⚖️',
        eliteParty: [{ id: 270, level: 78 }, { id: 253, level: 76 }, { id: 105, level: 75 }, { id: 64, level: 74 }, { id: 42, level: 73 }]
      },
      { step: 3, x: 25, y: 15, type: 'battle', enemyId: 120, name: '泳者·鹿紫雲一', text: "（雷光缠身的少年歪头）打雷的感觉...很舒服。你身上的咒力闻起来不错——让我尝尝。", emoji: '⚡',
        eliteParty: [{ id: 120, level: 80 }, { id: 126, level: 78 }, { id: 104, level: 77 }, { id: 87, level: 76 }, { id: 81, level: 75 }]
      },
      { step: 4, x: 12, y: 3, type: 'battle', enemyId: 609, name: '观战者·厌晚', text: '（结界边缘，厌晚饶有兴趣地走入）死滅回游？呵，和日蚀队的淘汰赛比起来倒是更直接。既然来了——我也当个泳者好了。', emoji: '🌙',
        eliteParty: [
          { id: 609, level: 84, devilFruit: 'df_yami' },
          { id: 608, level: 82 },
          { id: 94, level: 80 },
          { id: 604, level: 79 },
          { id: 130, level: 78 },
    ...
    midEvent: { enemyId: 120, name: '泳者·鹿紫雲一' },
    outro: [
      { name: "伏黑惠", text: "日車前辈最终站在了我们这边...他答应用自己的100点帮我们添加新规则。" },
      { name: "伏黑惠", text: "但要彻底结束这场游戏，我们需要找到更多强大的泳者取得合作。" },
      { name: "系统", text: "获得死滅回游通行证！可以自由进出各个结界领域。" }
    ],
  ...
  // ===== 咒术篇·肆：死滅回游·终局 =====
  {
    ...
    mapId: 100,
    title: "咒术篇·肆：死滅回游·终局",
    objective: "深入仙台结界，击败最强古代术师，与特级术师乙骨憂太联手终结死滅回游！",
    intro: [
      { name: "五条悟", text: "仙台结界是最危险的领域——两位千年前的术师在那里等着。一个是石流龍，另一个是鳥里（うとり）。" },
      { name: "五条悟", text: "不过放心，乙骨已经先一步进去了。他是继我之后的第二个特级术师——信任他。" },
      { name: "伏黑惠", text: "乙骨前辈...他和祈本里香的羁绊，是我见过最强的搭档之力。" }
    ],
    tasks: [
      { step: 0, x: 6, y: 8, type: 'battle', enemyId: 248, name: '千年术师·鳥里', text: "（优雅的女性术师浮于空中）噢？又有新的泳者...让我看看，这个时代的术师有什么本事。", emoji: '🦅',
        eliteParty: [{ id: 248, level: 82 }, { id: 329, level: 80 }, { id: 252, level: 79 }, { id: 18, level: 78 }]
      },
      { step: 1, x: 18, y: 12, type: 'battle', enemyId: 146, name: '千年术师·石流龍', text: "（巨大的咒力凝聚成龙形）吾乃千年之术师。汝之实力——且让老夫品鉴！御廚之火！", emoji: '🐲',
        isDouble: true,
        eliteParty: [{ id: 146, level: 86 }, { id: 142, level: 84 }, { id: 126, level: 83 }, { id: 110, level: 82 }, { id: 104, level: 81 }]
      },
      { step: 2, x: 22, y: 5, type: 'dialog', name: '乙骨憂太', text: "（温柔地微笑）你做得很好。接下来...让我来处理最后的收尾。里香——出来吧。", emoji: '💜' },
      { step: 3, x: 15, y: 3, type: 'battle', enemyId: 253, name: '特級術師·乙骨憂太', text: "（黑色的咒力如海啸般涌出）抱歉...既然要合作，我得先确认你的实力。里香が怒ってる——全力で来い！", emoji: '👻',
        eliteParty: [{ id: 253, level: 88 }, { id: 150, level: 86 }, { id: 178, level: 85 }, { id: 93, level: 84 }, { id: 248, level: 83 }, { id: 68, level: 82 }]
      },
      { step: 4, x: 10, y: 15, type: 'battle', enemyId: 68, name: '好兄弟·東堂葵', text: "好兄弟！！！你变强了！！在最后的决战之前——让我最后确认一次你的灵魂！！Boogie Woogie！！", emoji: '💪',
        eliteParty: [{ id: 68, level: 86 }, { id: 270, level: 85 }, { id: 105, level: 84 }, { id: 64, level: 83 }, { id: 57, level: 82 }]
      }
    ],
    midEvent: { enemyId: 253, name: '特級術師·乙骨憂太' },
    outro: [
      { name: "乙骨憂太", text: "你的实力已经超出了我的预期。里香也很喜欢你呢。" },
      { name: "東堂葵", text: "好兄弟！！你的灵魂在燃烧！！这就是真正的Best Friend！！" },
      { name: "五条悟", text: "死滅回游已经被终结。但这只是羂索棋局的一部分...更大的风暴就在前方。" },
      { name: "系统", text: "死滅回游终结！获得乙骨的认可！咒力操控精度大幅提升！" }
    ],
    reward: { gold: 45000, items: [{ id: 'vit_satk', count: 5 }, { id: 'vit_sdef', count: 5 }] }
  },
  ...
  // ===== 咒术篇·伍：过去的因缘 =====
  {
    ...
    mapId: 100,
    title: "咒术篇·伍：过去的因缘",
    objective: "天元开启记忆回溯，在过去的幻影中体验五条悟与夏油傑的青春、友情与决裂。",
    intro: [
      { name: "天元", text: "（苍老的声音从结界深处传来）...要理解羂索的目的，你必须先理解过去。" },
      { name: "天元", text: "羂索——曾经寄宿在一个叫加茂宪伦的人体内。而他真正的目标，与我有关。" },
      { name: "天元", text: "让我带你回到那个时代——五条悟和夏油傑还是挚友的时候。你将亲眼见证...最强的两人如何走向不同的道路。" },
      { name: "五条悟", text: "（沉默了一会儿）...夏油。这个名字...很久没有在我心里响过了。去吧，看看过去的真相。" }
    ],
    tasks: [
      { step: 0, x: 8, y: 10, type: 'battle', enemyId: 130, name: '记忆·星浆体护卫战', text: "（幻影重现——2008年的任务。护送天内理子前往天元处。刺客从四面八方逼近！）", emoji: '🌀',
        eliteParty: [{ id: 130, level: 82 }, { id: 132, level: 80 }, { id: 140, level: 79 }, { id: 88, level: 78 }]
      },
      { step: 1, x: 20, y: 6, type: 'dialog', name: '天元', text: "（旁白）那时的五条悟尚未觉醒无下限。而夏油...他的精灵能吸收其他精灵的力量——「咒灵操术」。他们是最强的搭档，也是最好的朋友。", emoji: '🔮' },
      { step: 2, x: 15, y: 15, type: 'battle', enemyId: 150, name: '记忆·伏黒甚爾', text: "（幻影中出现一个没有丝毫咒力的男人——但他的身体能力超越了人类极限）哼...术师？不过如此。", emoji: '🗡️',
        eliteParty: [{ id: 150, level: 86 }, { id: 270, level: 84 }, { id: 105, level: 83 }, { id: 64, level: 82 }, { id: 68, level: 81 }]
      },
      { step: 3, x: 25, y: 8, type: 'dialog', name: '天元', text: "甚爾杀死了天内理子...五条悟濒死之际觉醒了反转术式——从那一刻起，他成为了「最强」。但夏油的心...从此开始崩裂。", emoji: '💔' },
      { step: 4, x: 12, y: 5, type: 'battle', enemyId: 93, name: '记忆·夏油傑 [百鬼夜行]', text: "（夏油站在尸山血海中，身后飘浮着无数咒灵）我终于明白了。保护猴子毫无意义——术师才是这个世界最高等的存在。", emoji: '☠️',
        eliteParty: [{ id: 93, level: 88 }, { id: 92, level: 86 }, { id: 59, level: 85 }, { id: 48, level: 84 }, { id: 178, level: 83 }, { id: 142, level: 82 }]
      },
      { step: 5, x: 18, y: 12, type: 'battle', enemyId: 94, name: '记忆·青年五条悟 [無下限]', text: "（无限的虚空在身前展开。年轻的五条悟笑着说）既然你看到了过去——那就让最强的幻影来测试你配不配站在现在。", emoji: '♾️',
        eliteParty: [{ id: 94, level: 90 }, { id: 253, level: 88 }, { id: 248, level: 87 }, { id: 146, level: 86 }, { id: 126, level: 85 }, { id: 270, level: 84 }]
      }
    ],
    midEvent: { enemyId: 93, name: '记忆·夏油傑 [百鬼夜行]' },
    outro: [
      { name: "天元", text: "现在你明白了。夏油的肉体被羂索夺取...而那个灵魂，至今仍在某处沉睡。" },
      { name: "五条悟", text: "（声音低沉）...谢谢你看到了那段过去。夏油——我最好的朋友。这一次...我不会再犹豫了。" },
      { name: "系统", text: "通过记忆试炼！领悟了「反转术式」原理！全队恢复类咒术效率翻倍！" }
    ],
    reward: { gold: 55000, items: [{ id: 'vit_hp', count: 8 }, { id: 'exp_candy', count: 3 }] }
  },
  ...
  // ===== 咒术篇·陆：伏黒的危机 =====
  {
    ...
    mapId: 100,
    title: "咒术篇·陆：伏黒の危機",
    objective: "宿傩夺取了伏黒惠的身体！在伏黑意识被完全吞噬之前，击败寄生的宿傩！",
    intro: [
      { name: "釘崎野薔薇", text: "伏黑他...不对劲！！刚才他的眼睛变了——那不是伏黑的眼神！！" },
      { name: "宿傩(伏黑)", text: "（用伏黑的嘴角勾出一个残忍的笑容）...终于。这具身体的天赋远超那个虎杖。十种影法术——真是美妙。" },
      { name: "五条悟", text: "（瞬移出现）宿傩...！你竟然对我的学生下手...！" },
      { name: "宿傩(伏黑)", text: "五条悟。别急——先让这些小鬼们来试试。毕竟...我需要时间适应这具新身体。" },
      { name: "釘崎野薔薇", text: "伏黑！！你给我醒过来！！共鸣——芻霊呪法！！" }
    ],
    tasks: [
      { step: 0, x: 5, y: 5, type: 'battle', enemyId: 59, name: '宿傩之影·先锋', text: "（从伏黑体内涌出的咒力凝聚成实体——宿傩的分身在你面前成形）区区蝼蚁...也配挑战咒之王？", emoji: '👹',
        eliteParty: [{ id: 59, level: 86 }, { id: 92, level: 84 }, { id: 178, level: 83 }, { id: 48, level: 82 }]
      },
      { step: 1, x: 18, y: 10, type: 'battle', enemyId: 142, name: '暴走·魔虚罗', text: "（伏黑的式神「魔虚罗」被宿傩强制操控，斩击一切！）ガァァァ！！（失控的嘶吼）", emoji: '⚔️',
        isDouble: true,
        eliteParty: [{ id: 142, level: 88 }, { id: 140, level: 86 }, { id: 248, level: 85 }, { id: 93, level: 84 }, { id: 130, level: 83 }]
      },
      { step: 2, x: 12, y: 3, type: 'dialog', name: '釘崎野薔薇', text: "（喘着气）伏黑在抵抗...！我感觉到了！他的意识还没有被完全吞噬！！但是时间不多了——快！！", emoji: '🔨' },
      { step: 3, x: 22, y: 8, type: 'battle', enemyId: 150, name: '宿傩 [伏黒の体·四手]', text: "（四只手臂从伏黑身上展开，面部浮现宿傩的纹路）...有点意思。你们的执念——让我品鉴品鉴。「解」。", emoji: '👹',
        eliteParty: [{ id: 150, level: 92 }, { id: 253, level: 90 }, { id: 146, level: 89 }, { id: 142, level: 88 }, { id: 248, level: 87 }, { id: 178, level: 86 }]
      },
      { step: 4, x: 15, y: 15, type: 'battle', enemyId: 608, name: '暗影执行者·厌晚 [咒力觉醒]', text: '（战斗的余波中，厌晚走出废墟，身上缠绕着暗紫色的咒力）这段时间我也没闲着...咒力和虚空能量的融合——比想象中更有趣。来吧，趁你还热着。', emoji: '🌙',
        eliteParty: [
          { id: 608, level: 92, devilFruit: 'df_yami' },
          { id: 609, level: 90, devilFruit: 'df_supa' },
          { id: 610, level: 89 },
    ...
    midEvent: { enemyId: 150, name: '宿傩 [伏黒の体·四手]' },
    outro: [
      { name: "伏黑惠", text: "（跪在地上，恢复了自己的意识）...谢谢...我差点就...回不来了..." },
      { name: "五条悟", text: "伏黒，你做得很好。你的十种影法术比宿傩想象的更强大——因为你有不想失去的人。" },
      { name: "釘崎野薔薇", text: "下次再敢搞这种事...我揍你哦，伏黑。" },
      { name: "系统", text: "救出伏黑惠！伏黑的十种影法术共鸣——全队式神系技能威力提升！" }
    ],
    reward: { gold: 65000, items: [{ id: 'vit_spd', count: 5 }, { id: 'vit_crit', count: 3 }] }
  },
  ...
  // ===== 咒术篇·柒：羂索·千年の阴谋 =====
  {
    chapter: 15,
    mapId: 100,
    title: "咒术篇·柒：羂索·千年の阴谋",
    objective: "一切的幕后黑手——羂索现身！揭穿千年阴谋，击败这个不死的怪物！",
    intro: [
      { name: "五条悟", text: "终于找到你了——羂索。用着夏油的身体...你让我很不爽。" },
      { name: "羂索(夏油)", text: "（用夏油的脸露出夏油不可能露出的笑容）哎呀，五条悟。一千年了，每个时代都有像你这样自以为「最强」的人呢。" },
      { name: "羂索(夏油)", text: "死滅回游只是前菜。我真正的目的——是让天元与人类同化，创造一个全新的「咒术生态系」。" },
      { name: "天元", text: "（声音颤抖）如果他成功...所有人都将成为咒灵——这个世界将变成永恒的混沌。" },
      { name: "五条悟", text: "...不会让你得逞的。所有人——准备战斗。" }
    ],
    tasks: [
      { step: 0, x: 10, y: 12, type: 'battle', enemyId: 132, name: '裏梅', text: "（白发少年/少女面无表情）宿傩大人的意志——不容亵渎。在您触碰羂索大人之前...请先从裏梅这里通过。", emoji: '❄️',
        eliteParty: [{ id: 132, level: 88 }, { id: 87, level: 86 }, { id: 76, level: 85 }, { id: 15, level: 84 }, { id: 131, level: 83 }]
      },
      { step: 1, x: 20, y: 5, type: 'dialog', name: '五条悟', text: "裏梅已经被压制了。前方...就是羂索的领域。小心——那家伙活了一千年，经验比任何人都多。", emoji: '🔵' },
      { step: 2, x: 15, y: 8, type: 'battle', enemyId: 140, name: '改造咒胎·兵器群', text: "（大量人造咒灵从地面涌出——羂索千年研究的结晶！）嘎嘎嘎嘎嘎！！", emoji: '🤖',
        isDouble: true,
        eliteParty: [{ id: 140, level: 90 }, { id: 145, level: 88 }, { id: 178, level: 87 }, { id: 92, level: 86 }, { id: 59, level: 85 }, { id: 48, level: 84 }]
      },
      { step: 3, x: 25, y: 15, type: 'battle', enemyId: 93, name: '羂索 [夏油の体]', text: "（展开夏油的咒灵操术——但规模远超夏油的百鬼夜行）这具身体的术式很方便呢～让我展示一下——千年的收藏品。「極ノ番·獄門疆裏」！", emoji: '🧠',
        eliteParty: [{ id: 93, level: 94 }, { id: 150, level: 92 }, { id: 146, level: 91 }, { id: 253, level: 90 }, { id: 142, level: 89 }, { id: 248, level: 88 }]
      },
      { step: 4, x: 8, y: 3, type: 'battle', enemyId: 609, name: '厌晚 [真·觉醒]', text: '（羂索倒下的瞬间，厌晚从暗影中浮现，身上的虚空能量与咒力彼此交织）千年的怪物都被你打倒了...那我更不能落后。来——见识一下「虚空咒术」。', emoji: '🌙',
        eliteParty: [
          { id: 609, level: 94, devilFruit: 'df_mera' },
          { id: 608, level: 92, devilFruit: 'df_yami' },
          { id: 610, level: 91, devilFruit: 'df_supa' },
          { id: 94, level: 90 },
          { id: 604, level: 89 },
          { id: 603, level: 88 }
        ]
    ...
    midEvent: { enemyId: 93, name: '羂索 [夏油の体]' },
    outro: [
      { name: "五条悟", text: "（看着倒下的夏油的身体）...夏油。这一次，我亲手送你安息了。" },
      { name: "羂索(夏油)", text: "（咳血微笑）呵呵...你以为结束了？宿傩已经拿到了他需要的一切...我的使命已经完成了。" },
      { name: "五条悟", text: "（眼神一沉）...宿傩。他才是最后的敌人。" },
      { name: "系统", text: "击败羂索！但宿傩正在完成最终的准备...决战迫在眉睫！" }
    ],
    reward: { gold: 80000, items: [{ id: 'vit_patk', count: 8 }, { id: 'vit_satk', count: 8 }] }
  },
  ...
  // ===== 咒术篇·捌：新宿决战·最强対最強 =====
  {
    chapter: 16,
    mapId: 100,
    title: "咒术篇·捌：新宿决战·最強対最強",
    objective: "五条悟VS宿傩——一千年来最强术师与咒之王的宿命对决！在最强二人的战场中生存！",
    intro: [
      { name: "五条悟", text: "（摘下眼罩，六眼完全释放）...等了二十三年了。从我第一次听说「咒之王」的那天起。" },
      { name: "五条悟", text: "宿傩——你是一千年来唯一让我期待的对手。今天...我要证明一件事。" },
      { name: "宿傩", text: "（全部四只眼睛睁开，二十指完全复活）证明什么？" },
      { name: "五条悟", text: "「最强」这两个字——不是你的。" },
      { name: "宿傩", text: "（微笑）...来。" },
      { name: "系统", text: "新宿决战——全咒术师集结！你将在两位最强者的交锋中寻找破局之机！" }
    ],
    tasks: [
      { step: 0, x: 5, y: 5, type: 'battle', enemyId: 142, name: '宿傩·先手试探', text: "（宿傩漫不经心地挥手，一道无形斩击划破整条街道）「解」。...热身而已。", emoji: '🔪',
        eliteParty: [{ id: 142, level: 92 }, { id: 146, level: 90 }, { id: 248, level: 89 }, { id: 253, level: 88 }]
      },
      { step: 1, x: 15, y: 10, type: 'dialog', name: '五条悟', text: "（紫色的虚空在手中凝聚）「虚式·茈」——我来开路。你们负责封锁他的退路！不要靠近我和他的交战中心——那里的空间已经崩坏了。", emoji: '💜' },
      { step: 2, x: 22, y: 8, type: 'battle', enemyId: 150, name: '宿傩 [摩虎羅召喚]', text: "（一架巨大的法阵出现——斬撃適応的最强式神被宿傩驾驭！）十种影法术的王牌...在我手中，才是完全体。", emoji: '⚙️',
        isDouble: true,
        eliteParty: [{ id: 150, level: 96 }, { id: 142, level: 94 }, { id: 253, level: 93 }, { id: 248, level: 92 }, { id: 178, level: 91 }, { id: 146, level: 90 }]
      },
      { step: 3, x: 10, y: 3, type: 'dialog', name: '五条悟', text: "（大口喘气，领域已经碎裂三次）...哈。不愧是咒之王。这种程度的领域展开——我还是第一次被人正面击穿。不过...还没输呢。", emoji: '💪' },
      { step: 4, x: 18, y: 15, type: 'battle', enemyId: 150, name: '宿傩 [伏魔御廚子·神話形態]', text: "（宿傩展开完美领域——黑色的斬击充斥天地！）五条悟...你让我很开心。作为回礼——用最强的一击送你上路。「開」——伏魔御廚子。", emoji: '👹',
        eliteParty: [{ id: 150, level: 98 }, { id: 253, level: 96 }, { id: 146, level: 95 }, { id: 142, level: 94 }, { id: 248, level: 93 }, { id: 178, level: 92 }]
      }
    ],
    midEvent: { enemyId: 150, name: '宿傩 [伏魔御廚子·神話形態]' },
    outro: [
      { name: "五条悟", text: "（倒在废墟中，微笑着）...啊。输了呢。不过...我已经把他削弱到极限了。" },
      { name: "五条悟", text: "接下来...就拜托你了。我的...学生们。" },
      { name: "伏黑惠", text: "五条老师...！！" },
      { name: "釘崎野薔薇", text: "（咬牙）那个混蛋...！！五条老师为我们争取了机会——我们不能浪费！！" },
      { name: "系统", text: "五条悟倒下了...但宿傩已被削弱到极限！最终决战——就在眼前！" }
    ],
    reward: { gold: 150000, balls: { master: 3 }, items: [{ id: 'exp_candy', count: 5 }] }
  },
  ...
  // ===== 咒术篇·玖：咒术终焉 =====
  {
    ...
    mapId: 100,
    title: "咒术篇·玖：咒术终焉",
    objective: "继承五条悟的意志！全体术师集结——对决咒之王宿傩·最终形态！终结千年的诅咒！",
    intro: [
      { name: "伏黑惠", text: "五条老师把一切都赌在了我们身上。宿傩现在已经不是完整状态了——这是我们唯一的机会。" },
      { name: "釘崎野薔薇", text: "要打就来吧。芻霊呪法——共鸣。我来封住他的术式回路。" },
      { name: "東堂葵", text: "好兄弟！！就算只剩一只手——東堂葵也绝不退缩！！" },
      { name: "乙骨憂太", text: "五条老师一个人扛了那么久...现在轮到我们了。里香——全力模式。" },
      { name: "宿傩", text: "（受伤但仍站立）哼...全都来了吗。好——这才对。让我享受...最后的盛宴。" }
    ],
    tasks: [
      { step: 0, x: 8, y: 8, type: 'battle', enemyId: 92, name: '宿傩の残咒·百鬼群', text: "（宿傩的咒力碎片凝聚成无数低级咒灵！必须在它们汇合之前各个击破！）", emoji: '👻',
        isDouble: true,
        eliteParty: [{ id: 92, level: 96 }, { id: 93, level: 95 }, { id: 59, level: 94 }, { id: 178, level: 93 }, { id: 48, level: 92 }, { id: 150, level: 91 }]
      },
      { step: 1, x: 20, y: 5, type: 'battle', enemyId: 248, name: '宿傩·第二形態 [開]', text: "（宿傩的身体再次变化——额头的第三只眼睁开，黑色火焰笼罩全身）哈...被逼到这个地步。一千年来第一次。那我就——不再留手了。", emoji: '🔥',
        eliteParty: [{ id: 248, level: 97 }, { id: 253, level: 96 }, { id: 150, level: 95 }, { id: 146, level: 94 }, { id: 142, level: 93 }]
      },
      { step: 2, x: 15, y: 12, type: 'dialog', name: '伏黑惠', text: "（黑色的影子在脚下扩张）十种影法术——全解放。宿傩...这是你从我身体里偷走的力量。现在——我要夺回来。", emoji: '🔷' },
      { step: 3, x: 12, y: 3, type: 'battle', enemyId: 150, name: '真·宿傩 [咒之王·千年の呪い]', text: "（天空裂开——宿傩的领域覆盖了整个新宿！四臂·三眼·黑焰·无尽斩击——咒术之王的最终形态！）吾乃...两面宿傩。千年前如此——千年后亦然。来吧——让我见证，你们这个时代的意志！", emoji: '👹',
        eliteParty: [
          { id: 150, level: 100, devilFruit: 'df_mera' },
          { id: 253, level: 98, devilFruit: 'df_goro' },
          { id: 146, level: 97 },
          { id: 142, level: 96, devilFruit: 'df_supa' },
          { id: 248, level: 95 },
          { id: 178, level: 94 }
        ]
      },
      { step: 4, x: 22, y: 10, type: 'dialog', name: '伏黑惠', text: "（宿傩倒下后）...结束了。五条老师...我们做到了。", emoji: '🔷' },
      { step: 5, x: 15, y: 8, type: 'battle', enemyId: 609, name: '厌晚 [虚空咒王]', text: '（宿傩的咒力消散后，厌晚从虚空裂隙中走出。全身流转着虚空能量与咒力的完美融合体）一千年的咒之王被你打败了...我该高兴还是该紧张呢？答案是——都不。只是...单纯想和最强的你打一场。全力以赴——虚空咒术·终式。', emoji: '🌙',
        eliteParty: [
          { id: 609, level: 100, devilFruit: 'df_mera' },
          { id: 608, level: 98, devilFruit: 'df_yami' },
          { id: 610, level: 97, devilFruit: 'df_supa' },
          { id: 94, level: 96, devilFruit: 'df_goro' },
          { id: 604, level: 95 },
          { id: 603, level: 94 }
        ]
      }
    ],
    midEvent: { enemyId: 150, name: '真·宿傩 [咒之王·千年の呪い]' },
    outro: [
      { name: "宿傩", text: "（化为灰烬前，露出真诚的笑容）...一千年。终于...有人能在正面击败我了。不错...你们这个时代。" },
      { name: "五条悟", text: "（从担架上远远挥手）哟～看到了哦！果然...我教出来的学生是最强的嘛！（虽然躺着）" },
      { name: "伏黑惠", text: "五条老师...您就好好养伤吧。" },
      { name: "東堂葵", text: "好兄弟！！！这是最棒的战斗！！我们的灵魂永远共鸣！！！" },
  ...
  // ===== 莉可莉丝篇·序章：来自DA的委托 =====
  {
    ...
    tasks: [
      { step: 0, x: 8, y: 5, type: 'battle', enemyId: 120, name: '暴走的 可达鸭', text: '呜呜呜呜！！（浑身放出失控的水流，眼中闪烁着诡异的红光）', emoji: '🐥',
      ...
      { step: 2, x: 20, y: 12, type: 'battle', enemyId: 130, name: '暴走的 月亮伊布', text: '（月光中的黑影疯狂挥爪，芯片闪烁红光，理智已被完全覆盖）', emoji: '🌙',
        eliteParty: [{ id: 130, level: 50 }, { id: 120, level: 48 }, { id: 42, level: 47 }, { id: 88, level: 45 }]
      },
      { step: 3, x: 25, y: 6, type: 'battle', enemyId: 140, name: '暴走的 巨金怪', text: '（钢铁巨兽在建筑间横冲直撞，城市陷入一片混乱）', emoji: '🕷️',
  ...
  // ===== 门派篇·壹 =====
  {
    ...
    title: "门派篇·壹：剑起苍穹",
    objective: "李逍遥发来邀请函——三十门派武道大会即将开幕，各门派暗流涌动。",
    intro: [
      { name: "仙剑大侠·李逍遥", text: "（一封以剑气封印的信笺从天而降）老朋友，好久不见。我现在是蜀山派的代掌门——不，是被那群老头子硬推上去的。" },
      { name: "仙剑大侠·李逍遥", text: "十年一度的'三十门派武道大会'就要开始了。但今年不太一样——有人在暗中挑拨各门派之间的关系。" },
  ...
  // ===== 门派篇·贰 =====
  {
    ...
    outro: [
      { name: "天机阁阁主·鬼谷子", text: "太虚教...五百年前被三十门派联手剿灭的邪教。教主临死前发誓——五百年后卷土重来。" },
  ...
  // ===== 门派篇·陆 =====
  {
    ...
    outro: [
      ...
      { name: "系统", text: "明教与昆仑和解！厌晚提供了太虚秘境的情报。三十门派的联盟逐渐成形。" }
    ],
  ...
  // ===== 门派篇·柒 =====
  {
    ...
    outro: [
      ...
      { name: "华山派掌门·令狐冲", text: "太好了！但太虚教一定有所防备。我们需要三十门派全员出动。" },
      { name: "仙剑大侠·李逍遥", text: "我已经通知了所有门派。明天黎明——三十门派联盟正式出征！" },
      { name: "系统", text: "太虚秘境阵法全部破解！三十门派联盟集结完毕，最终决战在即。" }
    ],
  ...
  // ===== 门派篇·捌 =====
  {
    ...
    tasks: [
      ...
      { step: 4, x: 8, y: 3, type: 'dialog', name: '仙剑大侠·李逍遥', text: '（御剑落地）厌晚的情报至关重要！如果要净化虚空残响...需要仙灵界的净化术和三十门派的武功合力。我来执行净化——你来拖住太虚教主！', emoji: '⚔️' },
    ...
    outro: [
      { name: "仙剑大侠·李逍遥", text: "所有人都到齐了。三十门派联盟...加上厌晚...加上我的仙灵之力。这一战——决定武林的存亡。" },
  ...
  // ===== 门派篇·玖 =====
  {
    ...
    title: "门派篇·玖：三十门派·终战",
    objective: "率领三十门派联盟+厌晚+李逍遥，攻入太虚秘境，击败虚空残响！",
    intro: [
    ...
    tasks: [
      ...
      { step: 4, x: 15, y: 3, type: 'battle', enemyId: 283, name: '太虚教主·太虚真人 [虚空残响]', text: '（浑身缠绕着紫黑色虚空之力的身影睁开了眼，声音中混杂着两个意志）五百年...终于等到了。三十门派的后人们——今天你们将见证万界之门的开启！虚空归一——万物寂灭！', emoji: '⚫',
    ...
    outro: [
      ...
      { name: "武当祖师·张三丰", text: "正道不孤。三十门派虽各有恩怨，但大义面前，我等不分彼此。" },
      ...
      { name: "系统", text: "门派风云篇·完。三十门派联盟+厌晚合力击败太虚教！" },
