...
export const STORY_SCRIPT = [
  ...
  // ===== 异界篇·陆：深渊来客 (Map 105) =====
  {
    ...
    tasks: [
      ...
      { step: 4, x: 26, y: 8, type: 'battle', enemyId: 608, name: '深渊猎犬·影噬', text: '（三头黑犬从深渊最深处爬上来，对着马里奥身后的管道入口狂吠）', emoji: '🐺',
    ...
    outro: [
      { name: "马里奥", text: "嘿呀！你们好厉害！在我的世界，打怪就是跳上去踩一脚——这里的怪踩不了，得用精灵战斗！有意思！" },
  ...
  // ===== 异界篇·拾叁：次元风暴 (Map 107) =====
  {
    ...
    tasks: [
      ...
      { step: 2, x: 20, y: 8, type: 'battle', enemyId: 694, name: '次元风暴·核心体', text: '（风暴的核心——一个扭曲的次元裂隙，试图吞噬一切）', emoji: '🌀',
        eliteParty: [{ id: 694, level: 99 }, { id: 700, level: 98 }, { id: 695, level: 98 }, { id: 698, level: 97 }, { id: 607, level: 97 }, { id: 696, level: 96 }] },
      { step: 3, x: 24, y: 6, type: 'dialog', name: '花生', text: '（被风暴刮得东倒西歪但死死抱住一根柱子）大...大家别管我！先冲过去！我...我撑得住！', emoji: '🥜' },
      { step: 4, x: 24, y: 6, type: 'dialog', name: '林克', text: '（二话不说背起花生，一手持剑劈开风暴，一手稳稳地托住花生。沉默中的温柔——比任何语言都有力。）', emoji: '🗡️' }
    ],
    midEvent: { enemyId: 694, name: '次元风暴·核心体' },
    outro: [
      { name: "花生", text: "（红着脸从林克背上下来）谢...谢谢你，林克！你太帅了！" },
      { name: "林克", text: "...（微微一笑。这是他第一次在众人面前露出笑容。）" },
      { name: "暗影执行者·厌晚", text: "...次元霸主刚才的话让我不安。他说我们的力量是他的'食粮'——会不会是陷阱？" },
      { name: "十三", text: "有可能。但此刻已经没有退路了。前方就是虹之使者——彩虹之桥最强的看门人。" }
    ],
  ...
  // ===== 异界篇·拾柒：众神黄昏 (Map 109) =====
  {
    ...
    tasks: [
      ...
      { step: 4, x: 25, y: 6, type: 'dialog', name: '十三', text: '（紧握短刀）...终于见面了。次元霸主——吞噬我世界的怪物。第十三条法则：债，今天来讨。', emoji: '🗡️' }
    ],
    midEvent: { enemyId: 263, name: '创世守卫·终焉' },
    outro: [
      { name: "仙剑大侠·李逍遥", text: "守卫全部清除了。前方就是最终的战场。" },
      { name: "暗影执行者·厌晚", text: "...在进去之前。（从怀中取出一壶酒）我在蜀山偷的灵酒。打完了...回来一起喝。" },
      { name: "花生", text: "（眼眶湿润）厌晚...你这算是立flag吗？" },
      { name: "暗影执行者·厌晚", text: "...闭嘴。是提前庆祝。（把酒壶递给李逍遥）替我保管。打完了再喝。" },
      { name: "仙剑大侠·李逍遥", text: "（郑重地接过）好。打完了——大家一起。" },
      { name: "马里奥", text: "（伸出拳头）最后一战——嘿呀！" },
  ...
  // ===== 异界篇·终章：创世之战 (Map 109) =====
  {
    ...
    outro: [
      ...
      { name: "系统", text: "奖励：解锁隐藏称号【万界旅者】，所有同伴好感度MAX，解锁创世神殿探索" }
    ],
