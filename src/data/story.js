...
export const STORY_SCRIPT = [
  ...
  // ===== 第七章：幽灵古堡 =====
  {
    ...
    tasks: [
      ...
      { step: 3, x: 15, y: 10, type: 'battle', enemyId: 94, name: '噬魂 耿鬼', text: "多么美味的悲伤和愤怒！让我尝尝你的灵魂——哦，还有那个男孩的...", emoji: '👿' }
    ],
    ...
    outro: [
      ...
      { name: "系统", text: "苍的真实身份：日蚀队内部的卧底，为了复仇而潜伏三年。" }
    ],
  ...
  // ===== 第九章：极寒冻土 =====
  {
    ...
    outro: [
      ...
      { name: "系统", text: "日蚀队的副首领被击败。但首领仍然在暗处布局...日蚀计划已接近完成。" }
    ],
  ...
  // ===== 第十二章：银河空间站（终章前篇） =====
  {
    ...
    tasks: [
      ...
      { step: 3, x: 15, y: 5, type: 'battle', enemyId: 255, name: '日蚀队 首领·深渊', text: "（一个穿着漆黑长袍的男人缓缓转身）...你终于来了。三年前我毁掉了一个村庄，只为测试虚空能量。你的朋友苍——他以为自己在复仇，其实从一开始就是我计划的一部分。现在，见证新世界的诞生吧！", emoji: '⚫' }
    ],
