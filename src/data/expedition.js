...
export const EXPEDITION_ZONES = [
  {
    id: 'dark_forest', name: '幽暗森林', icon: '🌲', desc: '浓雾笼罩的神秘森林，草系和虫系精灵的乐园',
  ...
  {
    id: 'volcano', name: '火山洞窟', icon: '🌋', desc: '炽热的岩浆地带，火系和岩石系精灵聚集',
  ...
  {
    id: 'deep_sea', name: '深海遗迹', icon: '🏛️', desc: '沉没的古代文明，水系和龙系精灵守护着秘密',
  ...
  },
  {
    ...
    bonusMultiplier: 1.5,
    rewards: [
      { type: 'gold', min: 8000, max: 20000, weight: 20 },
      { type: 'mineral', id: 'stardust', count: 2, weight: 25 },
      { type: 'accessory_shard', count: 4, weight: 20 },
      { type: 'shiny_egg', level: 50, weight: 10 },
...
export function calcExpeditionBonus(teamPets, zone) {
  ...
  const maxMatches = isAllType ? Math.min(matchCount, 4) : matchCount;
